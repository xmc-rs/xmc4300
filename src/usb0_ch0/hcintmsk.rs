...
pub type XFER_COMPL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type CH_HLTD_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
#[doc = "Field `AHBErrMsk` reader - AHB Error Mask"]
pub type AHBERR_MSK_R = crate::BitReader;
#[doc = "Field `AHBErrMsk` writer - AHB Error Mask"]
pub type AHBERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type STALL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type NAK_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type ACK_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type NYET_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type XACT_ERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type BBL_ERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type FRM_OVRUN_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type DATA_TGL_ERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type BNAINTR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
...
pub type DESC_LST_ROLLINTR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, HCINTMSK_SPEC, O>;
impl R {
