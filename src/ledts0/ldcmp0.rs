...
pub type CMP_LD0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type CMP_LD1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type CMP_LD2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type CMP_LD3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp_ld0(&mut self) -> CMP_LD0_W<LDCMP0_SPEC, 0> {
        CMP_LD0_W::new(self)
    }
    #[doc = "Bits 8:15 - Compare Value for LED COL\\[x\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_ld1(&mut self) -> CMP_LD1_W<LDCMP0_SPEC, 8> {
        CMP_LD1_W::new(self)
    }
    #[doc = "Bits 16:23 - Compare Value for LED COL\\[x\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_ld2(&mut self) -> CMP_LD2_W<LDCMP0_SPEC, 16> {
        CMP_LD2_W::new(self)
    }
    #[doc = "Bits 24:31 - Compare Value for LED COL\\[x\\]"]
    #[inline(always)]
    #[must_use]
    pub fn cmp_ld3(&mut self) -> CMP_LD3_W<LDCMP0_SPEC, 24> {
        CMP_LD3_W::new(self)
    }
