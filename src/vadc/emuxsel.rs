...
impl W {
    ...
    #[doc = "Bits 0:3 - External Multiplexer Group for Interface x"]
    #[inline]
    pub fn emuxgrp0(&mut self) -> _EMUXGRP0W {
        _EMUXGRP0W { w: self }
    }
    #[doc = "Bits 4:7 - External Multiplexer Group for Interface x"]
    #[inline]
    pub fn emuxgrp1(&mut self) -> _EMUXGRP1W {
        _EMUXGRP1W { w: self }
    }
}
