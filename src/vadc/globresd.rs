...
pub type R = crate::R<GlobresdSpec>;
#[doc = "Register `GLOBRESD` writer"]
pub type W = crate::W<GlobresdSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn result(&mut self) -> ResultW<GlobresdSpec> {
        ResultW::new(self, 0)
    }
    #[doc = "Bit 31 - Valid Flag"]
    #[inline(always)]
    #[must_use]
    pub fn vf(&mut self) -> VfW<GlobresdSpec> {
        VfW::new(self, 31)
    }
}
...
pub struct GlobresdSpec;
impl crate::RegisterSpec for GlobresdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`globresd::R`](R) reader structure"]
impl crate::Readable for GlobresdSpec {}
#[doc = "`write(|w| ..)` method takes [`globresd::W`](W) writer structure"]
impl crate::Writable for GlobresdSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GLOBRESD to value 0"]
impl crate::Resettable for GlobresdSpec {
