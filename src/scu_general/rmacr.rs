...
#[doc = "Possible values of the field `RDWR`"]
...
#[doc = "Values that can be written to the field `RDWR`"]
pub enum RDWRW {
    #[doc = "transfer data from Retention Memory in Hibernate domain to RMDATA register"]
    CONST_0,
    #[doc = "transfer data from RMDATA into Retention Memory in Hibernate domain"]
...
impl<'a> _RDWRW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: RDWRW) -> &'a mut W {
        {
    ...
    pub fn const_0(self) -> &'a mut W {
        self.variant(RDWRW::CONST_0)
    }
    #[doc = "transfer data from RMDATA into Retention Memory in Hibernate domain"]
    #[inline]
    pub fn const_1(self) -> &'a mut W {
        self.variant(RDWRW::CONST_1)
    }
