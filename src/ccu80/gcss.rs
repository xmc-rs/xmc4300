...
pub type S0ST1S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S1ST1S` writer - Slice 1 status bit 1 set"]
pub type S1ST1S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S2ST1S` writer - Slice 2 status bit 1 set"]
pub type S2ST1S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S3ST1S` writer - Slice 3 status bit 1 set"]
pub type S3ST1S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S0ST2S` writer - Slice 0 status bit 2 set"]
pub type S0ST2S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S1ST2S` writer - Slice 1 status bit 2 set"]
pub type S1ST2S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S2ST2S` writer - Slice 2 status bit 2 set"]
pub type S2ST2S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
#[doc = "Field `S3ST2S` writer - Slice 3 status bit 2 set"]
pub type S3ST2S_W<'a, const O: u8> = crate::BitWriter<'a, GCSS_SPEC, O>;
impl W {
