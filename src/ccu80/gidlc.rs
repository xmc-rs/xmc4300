...
impl W {
    ...
    #[inline]
    pub fn cs0i(&mut self) -> _CS0IW {
        _CS0IW { w: self }
    }
    #[doc = "Bit 1 - CC81 IDLE mode clear"]
    #[inline]
    pub fn cs1i(&mut self) -> _CS1IW {
        _CS1IW { w: self }
    }
    #[doc = "Bit 2 - CC82 IDLE mode clear"]
    #[inline]
    pub fn cs2i(&mut self) -> _CS2IW {
        _CS2IW { w: self }
    }
    #[doc = "Bit 3 - CC83 IDLE mode clear"]
    #[inline]
    pub fn cs3i(&mut self) -> _CS3IW {
        _CS3IW { w: self }
    }
    #[doc = "Bit 8 - Prescaler Run Bit Set"]
    #[inline]
    pub fn sprb(&mut self) -> _SPRBW {
        _SPRBW { w: self }
    }
    #[doc = "Bit 10 - Parity Checker run bit set"]
    #[inline]
    pub fn spch(&mut self) -> _SPCHW {
        _SPCHW { w: self }
    }
}
