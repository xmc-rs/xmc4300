...
pub type S0ST1C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S1ST1C` writer - Slice 1 status bit 1 clear"]
pub type S1ST1C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S2ST1C` writer - Slice 2 status bit 1 clear"]
pub type S2ST1C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S3ST1C` writer - Slice 3 status bit 1 clear"]
pub type S3ST1C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S0ST2C` writer - Slice 0 status bit 2 clear"]
pub type S0ST2C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S1ST2C` writer - Slice 1 status bit 2 clear"]
pub type S1ST2C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S2ST2C` writer - Slice 2 status bit 2 clear"]
pub type S2ST2C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
#[doc = "Field `S3ST2C` writer - Slice 3 status bit 2 clear"]
pub type S3ST2C_W<'a, const O: u8> = crate::BitWriter<'a, GCSC_SPEC, O>;
impl W {
