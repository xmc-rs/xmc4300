...
pub struct PCRB_R(crate::FieldReader<bool, PCRB_A>);
impl PCRB_R {
    pub(crate) fn new(bits: bool) -> Self {
        PCRB_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PCRB_R {
    type Target = crate::FieldReader<bool, PCRB_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl R {
    ...
    pub fn pcrb(&self) -> PCRB_R {
        PCRB_R::new(((self.bits >> 10) & 0x01) != 0)
    }
}
