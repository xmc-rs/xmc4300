...
impl W {
    ...
    #[inline]
    pub fn ss0i(&mut self) -> _SS0IW {
        _SS0IW { w: self }
    }
    #[doc = "Bit 1 - CC81 IDLE mode set"]
    #[inline]
    pub fn ss1i(&mut self) -> _SS1IW {
        _SS1IW { w: self }
    }
    #[doc = "Bit 2 - CC82 IDLE mode set"]
    #[inline]
    pub fn ss2i(&mut self) -> _SS2IW {
        _SS2IW { w: self }
    }
    #[doc = "Bit 3 - CC83 IDLE mode set"]
    #[inline]
    pub fn ss3i(&mut self) -> _SS3IW {
        _SS3IW { w: self }
    }
    #[doc = "Bit 8 - Prescaler# Run Bit Clear"]
    #[inline]
    pub fn cprb(&mut self) -> _CPRBW {
        _CPRBW { w: self }
    }
    #[doc = "Bit 9 - Prescaler clear"]
    #[inline]
    pub fn psic(&mut self) -> _PSICW {
        _PSICW { w: self }
    }
    #[doc = "Bit 10 - Parity Checker Run bit clear"]
    #[inline]
    pub fn cpch(&mut self) -> _CPCHW {
        _CPCHW { w: self }
    }
}
