...
pub type R = crate::R<TxExcessiveDeferralErrorSpec>;
...
pub type TxexsdefR = crate::FieldReader<u32>;
impl R {
    ...
    #[inline(always)]
    pub fn txexsdef(&self) -> TxexsdefR {
        TxexsdefR::new(self.bits)
    }
}
#[doc = "Transmit Frame Count for Excessive Deferral Error Frames\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tx_excessive_deferral_error::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct TxExcessiveDeferralErrorSpec;
impl crate::RegisterSpec for TxExcessiveDeferralErrorSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_excessive_deferral_error::R`](R) reader structure"]
impl crate::Readable for TxExcessiveDeferralErrorSpec {}
#[doc = "`reset()` method sets TX_EXCESSIVE_DEFERRAL_ERROR to value 0"]
impl crate::Resettable for TxExcessiveDeferralErrorSpec {
