...
pub type TSENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSCFUPDT_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSINIT_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
#[doc = "Field `TSUPDT` reader - Timestamp Update"]
pub type TSUPDT_R = crate::BitReader;
#[doc = "Field `TSUPDT` writer - Timestamp Update"]
pub type TSUPDT_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSTRIG_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSADDREG_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSENALL_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSCTRLSSR_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSVER2ENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSIPENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSIPV6ENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSIPV4ENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSEVNTENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type TSMSTRENA_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
...
pub type SNAPTYPSEL_W<'a, const O: u8> = crate::FieldWriter<'a, TIMESTAMP_CONTROL_SPEC, 2, O>;
...
pub type TSENMACADDR_W<'a, const O: u8> = crate::BitWriter<'a, TIMESTAMP_CONTROL_SPEC, O>;
impl R {
