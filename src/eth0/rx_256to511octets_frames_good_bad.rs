...
pub struct RX256_511OCTGB_R(crate::FieldReader<u32, u32>);
impl RX256_511OCTGB_R {
    pub(crate) fn new(bits: u32) -> Self {
        RX256_511OCTGB_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX256_511OCTGB_R {
