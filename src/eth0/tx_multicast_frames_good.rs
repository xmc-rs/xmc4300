...
pub struct TxMulticastFramesGoodSpec;
impl crate::RegisterSpec for TxMulticastFramesGoodSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`tx_multicast_frames_good::R`](R) reader structure"]
impl crate::Readable for TxMulticastFramesGoodSpec {}
#[doc = "`reset()` method sets TX_MULTICAST_FRAMES_GOOD to value 0"]
impl crate::Resettable for TxMulticastFramesGoodSpec {
