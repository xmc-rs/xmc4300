...
pub type R = crate::R<MmcReceiveInterruptMaskSpec>;
#[doc = "Register `MMC_RECEIVE_INTERRUPT_MASK` writer"]
pub type W = crate::W<MmcReceiveInterruptMaskSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxgbfrmim(&mut self) -> RxgbfrmimW<MmcReceiveInterruptMaskSpec> {
        RxgbfrmimW::new(self, 0)
    }
    #[doc = "Bit 1 - MMC Receive Good Bad Octet Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxgboctim(&mut self) -> RxgboctimW<MmcReceiveInterruptMaskSpec> {
        RxgboctimW::new(self, 1)
    }
    #[doc = "Bit 2 - MMC Receive Good Octet Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxgoctim(&mut self) -> RxgoctimW<MmcReceiveInterruptMaskSpec> {
        RxgoctimW::new(self, 2)
    }
    #[doc = "Bit 3 - MMC Receive Broadcast Good Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxbcgfim(&mut self) -> RxbcgfimW<MmcReceiveInterruptMaskSpec> {
        RxbcgfimW::new(self, 3)
    }
    #[doc = "Bit 4 - MMC Receive Multicast Good Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxmcgfim(&mut self) -> RxmcgfimW<MmcReceiveInterruptMaskSpec> {
        RxmcgfimW::new(self, 4)
    }
    #[doc = "Bit 5 - MMC Receive CRC Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxcrcerfim(&mut self) -> RxcrcerfimW<MmcReceiveInterruptMaskSpec> {
        RxcrcerfimW::new(self, 5)
    }
    #[doc = "Bit 6 - MMC Receive Alignment Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxalgnerfim(&mut self) -> RxalgnerfimW<MmcReceiveInterruptMaskSpec> {
        RxalgnerfimW::new(self, 6)
    }
    #[doc = "Bit 7 - MMC Receive Runt Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxruntfim(&mut self) -> RxruntfimW<MmcReceiveInterruptMaskSpec> {
        RxruntfimW::new(self, 7)
    }
    #[doc = "Bit 8 - MMC Receive Jabber Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxjaberfim(&mut self) -> RxjaberfimW<MmcReceiveInterruptMaskSpec> {
        RxjaberfimW::new(self, 8)
    }
    #[doc = "Bit 9 - MMC Receive Undersize Good Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxusizegfim(&mut self) -> RxusizegfimW<MmcReceiveInterruptMaskSpec> {
        RxusizegfimW::new(self, 9)
    }
    #[doc = "Bit 10 - MMC Receive Oversize Good Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxosizegfim(&mut self) -> RxosizegfimW<MmcReceiveInterruptMaskSpec> {
        RxosizegfimW::new(self, 10)
    }
    #[doc = "Bit 11 - MMC Receive 64 Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx64octgbfim(&mut self) -> Rx64octgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx64octgbfimW::new(self, 11)
    }
    #[doc = "Bit 12 - MMC Receive 65 to 127 Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx65t127octgbfim(&mut self) -> Rx65t127octgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx65t127octgbfimW::new(self, 12)
    }
    #[doc = "Bit 13 - MMC Receive 128 to 255 Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx128t255octgbfim(&mut self) -> Rx128t255octgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx128t255octgbfimW::new(self, 13)
    }
    #[doc = "Bit 14 - MMC Receive 256 to 511 Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx256t511octgbfim(&mut self) -> Rx256t511octgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx256t511octgbfimW::new(self, 14)
    }
    #[doc = "Bit 15 - MMC Receive 512 to 1023 Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx512t1023octgbfim(&mut self) -> Rx512t1023octgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx512t1023octgbfimW::new(self, 15)
    }
    #[doc = "Bit 16 - MMC Receive 1024 to Maximum Octet Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx1024tmaxoctgbfim(&mut self) -> Rx1024tmaxoctgbfimW<MmcReceiveInterruptMaskSpec> {
        Rx1024tmaxoctgbfimW::new(self, 16)
    }
    #[doc = "Bit 17 - MMC Receive Unicast Good Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxucgfim(&mut self) -> RxucgfimW<MmcReceiveInterruptMaskSpec> {
        RxucgfimW::new(self, 17)
    }
    #[doc = "Bit 18 - MMC Receive Length Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxlenerfim(&mut self) -> RxlenerfimW<MmcReceiveInterruptMaskSpec> {
        RxlenerfimW::new(self, 18)
    }
    #[doc = "Bit 19 - MMC Receive Out Of Range Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxorangefim(&mut self) -> RxorangefimW<MmcReceiveInterruptMaskSpec> {
        RxorangefimW::new(self, 19)
    }
    #[doc = "Bit 20 - MMC Receive Pause Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxpausfim(&mut self) -> RxpausfimW<MmcReceiveInterruptMaskSpec> {
        RxpausfimW::new(self, 20)
    }
    #[doc = "Bit 21 - MMC Receive FIFO Overflow Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxfovfim(&mut self) -> RxfovfimW<MmcReceiveInterruptMaskSpec> {
        RxfovfimW::new(self, 21)
    }
    #[doc = "Bit 22 - MMC Receive VLAN Good Bad Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxvlangbfim(&mut self) -> RxvlangbfimW<MmcReceiveInterruptMaskSpec> {
        RxvlangbfimW::new(self, 22)
    }
    #[doc = "Bit 23 - MMC Receive Watchdog Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxwdogfim(&mut self) -> RxwdogfimW<MmcReceiveInterruptMaskSpec> {
        RxwdogfimW::new(self, 23)
    }
    #[doc = "Bit 24 - MMC Receive Error Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxrcverrfim(&mut self) -> RxrcverrfimW<MmcReceiveInterruptMaskSpec> {
        RxrcverrfimW::new(self, 24)
    }
    #[doc = "Bit 25 - MMC Receive Control Frame Counter Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rxctrlfim(&mut self) -> RxctrlfimW<MmcReceiveInterruptMaskSpec> {
...
pub struct MmcReceiveInterruptMaskSpec;
impl crate::RegisterSpec for MmcReceiveInterruptMaskSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mmc_receive_interrupt_mask::R`](R) reader structure"]
impl crate::Readable for MmcReceiveInterruptMaskSpec {}
#[doc = "`write(|w| ..)` method takes [`mmc_receive_interrupt_mask::W`](W) writer structure"]
impl crate::Writable for MmcReceiveInterruptMaskSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MMC_RECEIVE_INTERRUPT_MASK to value 0"]
impl crate::Resettable for MmcReceiveInterruptMaskSpec {
