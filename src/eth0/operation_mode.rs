...
pub type SR_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type OSF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type RTC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPERATION_MODE_SPEC, u8, u8, 2, O>;
...
pub type FUF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
#[doc = "Field `FEF` reader - Forward Error Frames"]
pub type FEF_R = crate::BitReader<bool>;
#[doc = "Field `FEF` writer - Forward Error Frames"]
pub type FEF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type ST_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type TTC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OPERATION_MODE_SPEC, u8, u8, 3, O>;
#[doc = "Field `FTF` reader - Flush Transmit FIFO"]
pub type FTF_R = crate::BitReader<bool>;
#[doc = "Field `FTF` writer - Flush Transmit FIFO"]
pub type FTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type TSF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type DFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type RSF_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
...
pub type DT_W<'a, const O: u8> = crate::BitWriter<'a, u32, OPERATION_MODE_SPEC, bool, O>;
impl R {
