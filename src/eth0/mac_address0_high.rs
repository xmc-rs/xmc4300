#[doc = "Reader of register MAC_ADDRESS0_HIGH"]
pub type R = crate::R<u32, super::MAC_ADDRESS0_HIGH>;
#[doc = "Writer for register MAC_ADDRESS0_HIGH"]
pub type W = crate::W<u32, super::MAC_ADDRESS0_HIGH>;
#[doc = "Register MAC_ADDRESS0_HIGH `reset()`'s with value 0x8000_ffff"]
impl crate::ResetValue for super::MAC_ADDRESS0_HIGH {
    type Type = u32;
    #[inline(always)]
