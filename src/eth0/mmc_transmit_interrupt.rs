...
impl super::MMC_TRANSMIT_INTERRUPT {
...
#[doc = r" Value of the field"]
pub struct TX512T1023OCTGBFISR {
    bits: bool,
}
...
#[doc = r" Value of the field"]
pub struct TX1024TMAXOCTGBFISR {
    bits: bool,
}
