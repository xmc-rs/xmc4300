...
pub type R = crate::R<MacAddress2HighSpec>;
#[doc = "Register `MAC_ADDRESS2_HIGH` writer"]
pub type W = crate::W<MacAddress2HighSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrhi(&mut self) -> AddrhiW<MacAddress2HighSpec> {
        AddrhiW::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbc(&mut self) -> MbcW<MacAddress2HighSpec> {
        MbcW::new(self, 24)
    }
    #[doc = "Bit 30 - Source Address"]
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SaW<MacAddress2HighSpec> {
        SaW::new(self, 30)
    }
    #[doc = "Bit 31 - Address Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ae(&mut self) -> AeW<MacAddress2HighSpec> {
        AeW::new(self, 31)
    }
}
...
pub struct MacAddress2HighSpec;
impl crate::RegisterSpec for MacAddress2HighSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mac_address2_high::R`](R) reader structure"]
impl crate::Readable for MacAddress2HighSpec {}
#[doc = "`write(|w| ..)` method takes [`mac_address2_high::W`](W) writer structure"]
impl crate::Writable for MacAddress2HighSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAC_ADDRESS2_HIGH to value 0xffff"]
impl crate::Resettable for MacAddress2HighSpec {
