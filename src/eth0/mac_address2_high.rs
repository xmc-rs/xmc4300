...
impl W {
    #[doc = "Bits 0:15 - MAC Address2 \\[47:32\\]"]
    #[inline(always)]
    pub fn addrhi(&mut self) -> ADDRHI_W<'_, MAC_ADDRESS2_HIGH_SPEC> {
        ADDRHI_W::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    pub fn mbc(&mut self) -> MBC_W<'_, MAC_ADDRESS2_HIGH_SPEC> {
        MBC_W::new(self, 24)
    }
    #[doc = "Bit 30 - Source Address"]
    #[inline(always)]
    pub fn sa(&mut self) -> SA_W<'_, MAC_ADDRESS2_HIGH_SPEC> {
        SA_W::new(self, 30)
    }
    #[doc = "Bit 31 - Address Enable"]
    #[inline(always)]
    pub fn ae(&mut self) -> AE_W<'_, MAC_ADDRESS2_HIGH_SPEC> {
        AE_W::new(self, 31)
    }
}
