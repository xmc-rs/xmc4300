...
pub type R = crate::R<MacAddress3HighSpec>;
#[doc = "Register `MAC_ADDRESS3_HIGH` writer"]
pub type W = crate::W<MacAddress3HighSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addrhi(&mut self) -> AddrhiW<MacAddress3HighSpec> {
        AddrhiW::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask Byte Control"]
    #[inline(always)]
    #[must_use]
    pub fn mbc(&mut self) -> MbcW<MacAddress3HighSpec> {
        MbcW::new(self, 24)
    }
    #[doc = "Bit 30 - Source Address"]
    #[inline(always)]
    #[must_use]
    pub fn sa(&mut self) -> SaW<MacAddress3HighSpec> {
        SaW::new(self, 30)
    }
    #[doc = "Bit 31 - Address Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ae(&mut self) -> AeW<MacAddress3HighSpec> {
        AeW::new(self, 31)
    }
}
...
pub struct MacAddress3HighSpec;
impl crate::RegisterSpec for MacAddress3HighSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mac_address3_high::R`](R) reader structure"]
impl crate::Readable for MacAddress3HighSpec {}
#[doc = "`write(|w| ..)` method takes [`mac_address3_high::W`](W) writer structure"]
impl crate::Writable for MacAddress3HighSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MAC_ADDRESS3_HIGH to value 0xffff"]
impl crate::Resettable for MacAddress3HighSpec {
