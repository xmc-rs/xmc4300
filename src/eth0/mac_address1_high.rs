#[doc = "Reader of register MAC_ADDRESS1_HIGH"]
pub type R = crate::R<u32, super::MAC_ADDRESS1_HIGH>;
#[doc = "Writer for register MAC_ADDRESS1_HIGH"]
pub type W = crate::W<u32, super::MAC_ADDRESS1_HIGH>;
#[doc = "Register MAC_ADDRESS1_HIGH `reset()`'s with value 0xffff"]
impl crate::ResetValue for super::MAC_ADDRESS1_HIGH {
    type Type = u32;
    #[inline(always)]
