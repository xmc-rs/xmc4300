...
pub type TWOKPE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prelen(&mut self) -> PRELEN_W<MAC_CONFIGURATION_SPEC, 0> {
        PRELEN_W::new(self)
    }
    #[doc = "Bit 2 - Receiver Enable"]
    #[inline(always)]
    #[must_use]
    pub fn re(&mut self) -> RE_W<MAC_CONFIGURATION_SPEC, 2> {
        RE_W::new(self)
    }
    #[doc = "Bit 3 - Transmitter Enable"]
    #[inline(always)]
    #[must_use]
    pub fn te(&mut self) -> TE_W<MAC_CONFIGURATION_SPEC, 3> {
        TE_W::new(self)
    }
    #[doc = "Bit 4 - Deferral Check"]
    #[inline(always)]
    #[must_use]
    pub fn dc(&mut self) -> DC_W<MAC_CONFIGURATION_SPEC, 4> {
        DC_W::new(self)
    }
    #[doc = "Bits 5:6 - Back-Off Limit"]
    #[inline(always)]
    #[must_use]
    pub fn bl(&mut self) -> BL_W<MAC_CONFIGURATION_SPEC, 5> {
        BL_W::new(self)
    }
    #[doc = "Bit 7 - Automatic Pad or CRC Stripping"]
    #[inline(always)]
    #[must_use]
    pub fn acs(&mut self) -> ACS_W<MAC_CONFIGURATION_SPEC, 7> {
        ACS_W::new(self)
    }
    #[doc = "Bit 9 - Disable Retry"]
    #[inline(always)]
    #[must_use]
    pub fn dr(&mut self) -> DR_W<MAC_CONFIGURATION_SPEC, 9> {
        DR_W::new(self)
    }
    #[doc = "Bit 10 - Checksum Offload"]
    #[inline(always)]
    #[must_use]
    pub fn ipc(&mut self) -> IPC_W<MAC_CONFIGURATION_SPEC, 10> {
        IPC_W::new(self)
    }
    #[doc = "Bit 11 - Duplex Mode"]
    #[inline(always)]
    #[must_use]
    pub fn dm(&mut self) -> DM_W<MAC_CONFIGURATION_SPEC, 11> {
        DM_W::new(self)
    }
    #[doc = "Bit 12 - Loopback Mode"]
    #[inline(always)]
    #[must_use]
    pub fn lm(&mut self) -> LM_W<MAC_CONFIGURATION_SPEC, 12> {
        LM_W::new(self)
    }
    #[doc = "Bit 13 - Disable Receive Own"]
    #[inline(always)]
    #[must_use]
    pub fn do_(&mut self) -> DO_W<MAC_CONFIGURATION_SPEC, 13> {
        DO_W::new(self)
    }
    #[doc = "Bit 14 - Speed"]
    #[inline(always)]
    #[must_use]
    pub fn fes(&mut self) -> FES_W<MAC_CONFIGURATION_SPEC, 14> {
        FES_W::new(self)
    }
    #[doc = "Bit 16 - Disable Carrier Sense During Transmission"]
    #[inline(always)]
    #[must_use]
    pub fn dcrs(&mut self) -> DCRS_W<MAC_CONFIGURATION_SPEC, 16> {
        DCRS_W::new(self)
    }
    #[doc = "Bits 17:19 - Inter-Frame Gap"]
    #[inline(always)]
    #[must_use]
    pub fn ifg(&mut self) -> IFG_W<MAC_CONFIGURATION_SPEC, 17> {
        IFG_W::new(self)
    }
    #[doc = "Bit 20 - Jumbo Frame Enable"]
    #[inline(always)]
    #[must_use]
    pub fn je(&mut self) -> JE_W<MAC_CONFIGURATION_SPEC, 20> {
        JE_W::new(self)
    }
    #[doc = "Bit 22 - Jabber Disable"]
    #[inline(always)]
    #[must_use]
    pub fn jd(&mut self) -> JD_W<MAC_CONFIGURATION_SPEC, 22> {
        JD_W::new(self)
    }
    #[doc = "Bit 23 - Watchdog Disable"]
    #[inline(always)]
    #[must_use]
    pub fn wd(&mut self) -> WD_W<MAC_CONFIGURATION_SPEC, 23> {
        WD_W::new(self)
    }
    #[doc = "Bit 25 - CRC Stripping of Type Frames"]
    #[inline(always)]
    #[must_use]
    pub fn cst(&mut self) -> CST_W<MAC_CONFIGURATION_SPEC, 25> {
        CST_W::new(self)
    }
    #[doc = "Bit 27 - IEEE 802.3as support for 2K packets Enable"]
    #[inline(always)]
    #[must_use]
    pub fn twokpe(&mut self) -> TWOKPE_W<MAC_CONFIGURATION_SPEC, 27> {
        TWOKPE_W::new(self)
    }
