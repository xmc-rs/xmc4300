...
pub type ATDS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RPBL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swr(&mut self) -> SWR_W<BUS_MODE_SPEC, 0> {
        SWR_W::new(self)
    }
    #[doc = "Bit 1 - DMA Arbitration Scheme"]
    #[inline(always)]
    #[must_use]
    pub fn da(&mut self) -> DA_W<BUS_MODE_SPEC, 1> {
        DA_W::new(self)
    }
    #[doc = "Bits 2:6 - Descriptor Skip Length"]
    #[inline(always)]
    #[must_use]
    pub fn dsl(&mut self) -> DSL_W<BUS_MODE_SPEC, 2> {
        DSL_W::new(self)
    }
    #[doc = "Bit 7 - Alternate Descriptor Size"]
    #[inline(always)]
    #[must_use]
    pub fn atds(&mut self) -> ATDS_W<BUS_MODE_SPEC, 7> {
        ATDS_W::new(self)
    }
    #[doc = "Bits 8:13 - Programmable Burst Length"]
    #[inline(always)]
    #[must_use]
    pub fn pbl(&mut self) -> PBL_W<BUS_MODE_SPEC, 8> {
        PBL_W::new(self)
    }
    #[doc = "Bits 14:15 - Priority Ratio"]
    #[inline(always)]
    #[must_use]
    pub fn pr(&mut self) -> PR_W<BUS_MODE_SPEC, 14> {
        PR_W::new(self)
    }
    #[doc = "Bit 16 - Fixed Burst"]
    #[inline(always)]
    #[must_use]
    pub fn fb(&mut self) -> FB_W<BUS_MODE_SPEC, 16> {
        FB_W::new(self)
    }
    #[doc = "Bits 17:22 - Rx DMA PBL"]
    #[inline(always)]
    #[must_use]
    pub fn rpbl(&mut self) -> RPBL_W<BUS_MODE_SPEC, 17> {
        RPBL_W::new(self)
    }
    #[doc = "Bit 23 - Use Seperate PBL"]
    #[inline(always)]
    #[must_use]
    pub fn usp(&mut self) -> USP_W<BUS_MODE_SPEC, 23> {
        USP_W::new(self)
    }
    #[doc = "Bit 24 - 8xPBL Mode"]
    #[inline(always)]
    #[must_use]
    pub fn pblx8(&mut self) -> PBLX8_W<BUS_MODE_SPEC, 24> {
        PBLX8_W::new(self)
    }
    #[doc = "Bit 25 - Address Aligned Beats"]
    #[inline(always)]
    #[must_use]
    pub fn aal(&mut self) -> AAL_W<BUS_MODE_SPEC, 25> {
        AAL_W::new(self)
    }
    #[doc = "Bit 26 - Mixed Burst"]
    #[inline(always)]
    #[must_use]
    pub fn mb(&mut self) -> MB_W<BUS_MODE_SPEC, 26> {
        MB_W::new(self)
    }
    #[doc = "Bit 27 - Transmit Priority"]
    #[inline(always)]
    #[must_use]
    pub fn txpr(&mut self) -> TXPR_W<BUS_MODE_SPEC, 27> {
        TXPR_W::new(self)
    }
