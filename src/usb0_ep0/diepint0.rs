...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt"]
    #[inline(always)]
    pub fn xfer_compl(&mut self) -> XFER_COMPL_W<'_, DIEPINT0_SPEC> {
    ...
    #[doc = "Bit 3 - Timeout Condition"]
    #[inline(always)]
    pub fn time_out(&mut self) -> TIME_OUT_W<'_, DIEPINT0_SPEC> {
        TIME_OUT_W::new(self, 3)
    }
    #[doc = "Bit 4 - IN Token Received When TxFIFO is Empty"]
    #[inline(always)]
    pub fn intkn_txfemp(&mut self) -> INTKN_TXFEMP_W<'_, DIEPINT0_SPEC> {
        INTKN_TXFEMP_W::new(self, 4)
    }
    #[doc = "Bit 6 - IN Endpoint NAK Effective"]
    #[inline(always)]
    pub fn inepnak_eff(&mut self) -> INEPNAK_EFF_W<'_, DIEPINT0_SPEC> {
