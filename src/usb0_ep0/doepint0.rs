...
impl W {
    #[doc = "Bit 0 - Transfer Completed Interrupt"]
    #[inline(always)]
    pub fn xfer_compl(&mut self) -> XFER_COMPL_W<'_, DOEPINT0_SPEC> {
    ...
    #[doc = "Bit 3 - SETUP Phase Done"]
    #[inline(always)]
    pub fn set_up(&mut self) -> SET_UP_W<'_, DOEPINT0_SPEC> {
        SET_UP_W::new(self, 3)
    }
    #[doc = "Bit 4 - OUT Token Received When Endpoint Disabled"]
    #[inline(always)]
    pub fn outtkn_epdis(&mut self) -> OUTTKN_EPDIS_W<'_, DOEPINT0_SPEC> {
        OUTTKN_EPDIS_W::new(self, 4)
    }
    #[doc = "Bit 5 - Status Phase Received For Control Write"]
    #[inline(always)]
    pub fn sts_phse_rcvd(&mut self) -> STS_PHSE_RCVD_W<'_, DOEPINT0_SPEC> {
        STS_PHSE_RCVD_W::new(self, 5)
    }
    #[doc = "Bit 6 - Back-to-Back SETUP Packets Received"]
    #[inline(always)]
    pub fn back2back_setup(&mut self) -> BACK2BACK_SETUP_W<'_, DOEPINT0_SPEC> {
    ...
    #[doc = "Bit 11 - Packet Dropped Status"]
    #[inline(always)]
    pub fn pkt_drp_sts(&mut self) -> PKT_DRP_STS_W<'_, DOEPINT0_SPEC> {
        PKT_DRP_STS_W::new(self, 11)
    }
    #[doc = "Bit 12 - BbleErr (Babble Error) interrupt"]
    #[inline(always)]
    pub fn bble_err_intrpt(&mut self) -> BBLE_ERR_INTRPT_W<'_, DOEPINT0_SPEC> {
