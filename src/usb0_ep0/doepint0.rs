...
pub type SET_UP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUTTKN_EPDIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type STS_PHSE_RCVD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PKT_DRP_STS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BBLE_ERR_INTRPT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NYETINTRPT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfer_compl(&mut self) -> XFER_COMPL_W<DOEPINT0_SPEC, 0> {
        XFER_COMPL_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint Disabled Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn epdisbld(&mut self) -> EPDISBLD_W<DOEPINT0_SPEC, 1> {
        EPDISBLD_W::new(self)
    }
    #[doc = "Bit 2 - AHB Error"]
    #[inline(always)]
    #[must_use]
    pub fn ahberr(&mut self) -> AHBERR_W<DOEPINT0_SPEC, 2> {
        AHBERR_W::new(self)
    }
    #[doc = "Bit 3 - SETUP Phase Done"]
    #[inline(always)]
    #[must_use]
    pub fn set_up(&mut self) -> SET_UP_W<DOEPINT0_SPEC, 3> {
        SET_UP_W::new(self)
    }
    #[doc = "Bit 4 - OUT Token Received When Endpoint Disabled"]
    #[inline(always)]
    #[must_use]
    pub fn outtkn_epdis(&mut self) -> OUTTKN_EPDIS_W<DOEPINT0_SPEC, 4> {
        OUTTKN_EPDIS_W::new(self)
    }
    #[doc = "Bit 5 - Status Phase Received For Control Write"]
    #[inline(always)]
    #[must_use]
    pub fn sts_phse_rcvd(&mut self) -> STS_PHSE_RCVD_W<DOEPINT0_SPEC, 5> {
        STS_PHSE_RCVD_W::new(self)
    }
    #[doc = "Bit 6 - Back-to-Back SETUP Packets Received"]
    #[inline(always)]
    #[must_use]
    pub fn back2back_setup(&mut self) -> BACK2BACK_SETUP_W<DOEPINT0_SPEC, 6> {
        BACK2BACK_SETUP_W::new(self)
    }
    #[doc = "Bit 9 - BNA (Buffer Not Available) Interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn bnaintr(&mut self) -> BNAINTR_W<DOEPINT0_SPEC, 9> {
        BNAINTR_W::new(self)
    }
    #[doc = "Bit 11 - Packet Dropped Status"]
    #[inline(always)]
    #[must_use]
    pub fn pkt_drp_sts(&mut self) -> PKT_DRP_STS_W<DOEPINT0_SPEC, 11> {
        PKT_DRP_STS_W::new(self)
    }
    #[doc = "Bit 12 - BbleErr (Babble Error) interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn bble_err_intrpt(&mut self) -> BBLE_ERR_INTRPT_W<DOEPINT0_SPEC, 12> {
        BBLE_ERR_INTRPT_W::new(self)
    }
    #[doc = "Bit 13 - NAK interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nakintrpt(&mut self) -> NAKINTRPT_W<DOEPINT0_SPEC, 13> {
        NAKINTRPT_W::new(self)
    }
    #[doc = "Bit 14 - NYET interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nyetintrpt(&mut self) -> NYETINTRPT_W<DOEPINT0_SPEC, 14> {
