...
pub type R = crate::R<DiepctlIsocontSpec>;
#[doc = "Register `DIEPCTL_ISOCONT` writer"]
pub type W = crate::W<DiepctlIsocontSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mps(&mut self) -> MpsW<DiepctlIsocontSpec> {
        MpsW::new(self, 0)
    }
    #[doc = "Bit 15 - USB Active Endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn usbact_ep(&mut self) -> UsbactEpW<DiepctlIsocontSpec> {
        UsbactEpW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint Type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EptypeW<DiepctlIsocontSpec> {
        EptypeW::new(self, 18)
    }
    #[doc = "Bit 20 - Snoop Mode"]
    #[inline(always)]
    #[must_use]
    pub fn snp(&mut self) -> SnpW<DiepctlIsocontSpec> {
        SnpW::new(self, 20)
    }
    #[doc = "Bit 21 - STALL Handshake"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> StallW<DiepctlIsocontSpec> {
        StallW::new(self, 21)
    }
    #[doc = "Bits 22:25 - TxFIFO Number"]
    #[inline(always)]
    #[must_use]
    pub fn tx_fnum(&mut self) -> TxFnumW<DiepctlIsocontSpec> {
        TxFnumW::new(self, 22)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    #[must_use]
    pub fn cnak(&mut self) -> CnakW<DiepctlIsocontSpec> {
        CnakW::new(self, 26)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    #[must_use]
    pub fn snak(&mut self) -> SnakW<DiepctlIsocontSpec> {
        SnakW::new(self, 27)
    }
    #[doc = "Bit 28 - In non-Scatter/Gather DMA mode: Set Even frame"]
    #[inline(always)]
    #[must_use]
    pub fn set_even_fr(&mut self) -> SetEvenFrW<DiepctlIsocontSpec> {
        SetEvenFrW::new(self, 28)
    }
    #[doc = "Bit 29 - Set Odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn set_odd_fr(&mut self) -> SetOddFrW<DiepctlIsocontSpec> {
        SetOddFrW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint Disable"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EpdisW<DiepctlIsocontSpec> {
        EpdisW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint Enable"]
    #[inline(always)]
    #[must_use]
    pub fn epena(&mut self) -> EpenaW<DiepctlIsocontSpec> {
        EpenaW::new(self, 31)
    }
}
...
pub struct DiepctlIsocontSpec;
impl crate::RegisterSpec for DiepctlIsocontSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepctl_isocont::R`](R) reader structure"]
impl crate::Readable for DiepctlIsocontSpec {}
#[doc = "`write(|w| ..)` method takes [`diepctl_isocont::W`](W) writer structure"]
impl crate::Writable for DiepctlIsocontSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEPCTL_ISOCONT to value 0"]
impl crate::Resettable for DiepctlIsocontSpec {
