...
impl W {
    ...
    #[inline]
    pub fn set_d0pid(&mut self) -> _SETD0PIDW {
        _SETD0PIDW { w: self }
    }
    #[doc = "Bit 29 - 29 Set DATA1 PID"]
    #[inline]
    pub fn set_d1pid(&mut self) -> _SETD1PIDW {
        _SETD1PIDW { w: self }
    }
    #[doc = "Bit 30 - Endpoint Disable"]
    #[inline]
