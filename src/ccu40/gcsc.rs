...
pub type S0STC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `S1STC` writer - Slice 1 status bit clear"]
pub type S1STC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `S2STC` writer - Slice 2 status bit clear"]
pub type S2STC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `S3STC` writer - Slice 3 status bit clear"]
pub type S3STC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn s0stc(&mut self) -> S0STC_W<GCSC_SPEC, 16> {
        S0STC_W::new(self)
    }
    #[doc = "Bit 17 - Slice 1 status bit clear"]
    #[inline(always)]
    #[must_use]
    pub fn s1stc(&mut self) -> S1STC_W<GCSC_SPEC, 17> {
        S1STC_W::new(self)
    }
    #[doc = "Bit 18 - Slice 2 status bit clear"]
    #[inline(always)]
    #[must_use]
    pub fn s2stc(&mut self) -> S2STC_W<GCSC_SPEC, 18> {
        S2STC_W::new(self)
    }
    #[doc = "Bit 19 - Slice 3 status bit clear"]
    #[inline(always)]
    #[must_use]
    pub fn s3stc(&mut self) -> S3STC_W<GCSC_SPEC, 19> {
        S3STC_W::new(self)
    }
