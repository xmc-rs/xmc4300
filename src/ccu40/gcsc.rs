...
impl W {
    ...
    #[inline(always)]
    pub fn s0stc(&mut self) -> S0STC_W<'_, GCSC_SPEC> {
        S0STC_W::new(self, 16)
    }
    #[doc = "Bit 17 - Slice 1 status bit clear"]
    #[inline(always)]
    pub fn s1stc(&mut self) -> S1STC_W<'_, GCSC_SPEC> {
        S1STC_W::new(self, 17)
    }
    #[doc = "Bit 18 - Slice 2 status bit clear"]
    #[inline(always)]
    pub fn s2stc(&mut self) -> S2STC_W<'_, GCSC_SPEC> {
        S2STC_W::new(self, 18)
    }
    #[doc = "Bit 19 - Slice 3 status bit clear"]
    #[inline(always)]
    pub fn s3stc(&mut self) -> S3STC_W<'_, GCSC_SPEC> {
        S3STC_W::new(self, 19)
    }
}
