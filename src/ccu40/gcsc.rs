...
impl W {
    ...
    #[inline]
    pub fn s0stc(&mut self) -> _S0STCW {
        _S0STCW { w: self }
    }
    #[doc = "Bit 17 - Slice 1 status bit clear"]
    #[inline]
    pub fn s1stc(&mut self) -> _S1STCW {
        _S1STCW { w: self }
    }
    #[doc = "Bit 18 - Slice 2 status bit clear"]
    #[inline]
    pub fn s2stc(&mut self) -> _S2STCW {
        _S2STCW { w: self }
    }
    #[doc = "Bit 19 - Slice 3 status bit clear"]
    #[inline]
    pub fn s3stc(&mut self) -> _S3STCW {
        _S3STCW { w: self }
    }
}
