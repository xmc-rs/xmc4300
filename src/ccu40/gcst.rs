...
impl R {
    ...
    #[inline(always)]
    pub fn cc40st(&self) -> Cc40stR {
        Cc40stR::new(((self.bits >> 16) & 1) != 0)
    }
    #[doc = "Bit 17 - Slice 1 status bit"]
    #[inline(always)]
    pub fn cc41st(&self) -> Cc41stR {
        Cc41stR::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - Slice 2 status bit"]
    #[inline(always)]
    pub fn cc42st(&self) -> Cc42stR {
        Cc42stR::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - Slice 3 status bit"]
    #[inline(always)]
    pub fn cc43st(&self) -> Cc43stR {
        Cc43stR::new(((self.bits >> 19) & 1) != 0)
    }
}
