...
impl W {
    ...
    #[inline]
    pub fn s0sts(&mut self) -> _S0STSW {
        _S0STSW { w: self }
    }
    #[doc = "Bit 17 - Slice 1 status bit set"]
    #[inline]
    pub fn s1sts(&mut self) -> _S1STSW {
        _S1STSW { w: self }
    }
    #[doc = "Bit 18 - Slice 2 status bit set"]
    #[inline]
    pub fn s2sts(&mut self) -> _S2STSW {
        _S2STSW { w: self }
    }
    #[doc = "Bit 19 - Slice 3 status bit set"]
    #[inline]
    pub fn s3sts(&mut self) -> _S3STSW {
        _S3STSW { w: self }
    }
}
