...
impl W {
    ...
    #[inline(always)]
    pub fn s0sts(&mut self) -> S0STS_W<'_, GCSS_SPEC> {
        S0STS_W::new(self, 16)
    }
    #[doc = "Bit 17 - Slice 1 status bit set"]
    #[inline(always)]
    pub fn s1sts(&mut self) -> S1STS_W<'_, GCSS_SPEC> {
        S1STS_W::new(self, 17)
    }
    #[doc = "Bit 18 - Slice 2 status bit set"]
    #[inline(always)]
    pub fn s2sts(&mut self) -> S2STS_W<'_, GCSS_SPEC> {
        S2STS_W::new(self, 18)
    }
    #[doc = "Bit 19 - Slice 3 status bit set"]
    #[inline(always)]
    pub fn s3sts(&mut self) -> S3STS_W<'_, GCSS_SPEC> {
        S3STS_W::new(self, 19)
    }
}
