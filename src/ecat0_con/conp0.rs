...
pub type RXD0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RXD0_A, 2, O>;
...
pub type RXD1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RXD1_A, 2, O>;
...
pub type RXD2_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RXD2_A, 2, O>;
...
pub type RXD3_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RXD3_A, 2, O>;
...
pub type RX_ERR_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RX_ERR_A, 2, O>;
...
pub type RX_DV_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RX_DV_A, 2, O>;
...
pub type RX_CLK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, RX_CLK_A, 2, O>;
...
pub type LINK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, LINK_A, 2, O>;
...
pub type TX_CLK_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, TX_CLK_A, 2, O>;
...
pub type TX_SHIFT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CONP0_SPEC, u8, TX_SHIFT_A, 2, O>;
