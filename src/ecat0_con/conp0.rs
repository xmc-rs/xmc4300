...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxd0(&mut self) -> RXD0_W<CONP0_SPEC, 0> {
        RXD0_W::new(self)
    }
    #[doc = "Bits 2:3 - Port0 Receive Input 1 Select"]
    #[inline(always)]
    #[must_use]
    pub fn rxd1(&mut self) -> RXD1_W<CONP0_SPEC, 2> {
        RXD1_W::new(self)
    }
    #[doc = "Bits 4:5 - Port0 Receive Input 2 Select"]
    #[inline(always)]
    #[must_use]
    pub fn rxd2(&mut self) -> RXD2_W<CONP0_SPEC, 4> {
        RXD2_W::new(self)
    }
    #[doc = "Bits 6:7 - Port0 Receive Input 3 Select"]
    #[inline(always)]
    #[must_use]
    pub fn rxd3(&mut self) -> RXD3_W<CONP0_SPEC, 6> {
        RXD3_W::new(self)
    }
    #[doc = "Bits 8:9 - Port0 MII RX ERROR Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn rx_err(&mut self) -> RX_ERR_W<CONP0_SPEC, 8> {
        RX_ERR_W::new(self)
    }
    #[doc = "Bits 10:11 - Port0 MII RX DV Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn rx_dv(&mut self) -> RX_DV_W<CONP0_SPEC, 10> {
        RX_DV_W::new(self)
    }
    #[doc = "Bits 12:13 - Port0 MII RX Clock Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn rx_clk(&mut self) -> RX_CLK_W<CONP0_SPEC, 12> {
        RX_CLK_W::new(self)
    }
    #[doc = "Bits 16:17 - Port0 PHY Link Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn link(&mut self) -> LINK_W<CONP0_SPEC, 16> {
        LINK_W::new(self)
    }
    #[doc = "Bits 28:29 - Port0 MII TX Clock Input Select"]
    #[inline(always)]
    #[must_use]
    pub fn tx_clk(&mut self) -> TX_CLK_W<CONP0_SPEC, 28> {
        TX_CLK_W::new(self)
    }
    #[doc = "Bits 30:31 - Port0 Manual TX Shift configuration"]
    #[inline(always)]
    #[must_use]
    pub fn tx_shift(&mut self) -> TX_SHIFT_W<CONP0_SPEC, 30> {
        TX_SHIFT_W::new(self)
    }
