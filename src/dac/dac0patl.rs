...
pub type R = crate::R<Dac0patlSpec>;
#[doc = "Register `DAC0PATL` writer"]
pub type W = crate::W<Dac0patlSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pat0(&mut self) -> Pat0W<Dac0patlSpec> {
        Pat0W::new(self, 0)
    }
    #[doc = "Bits 5:9 - Pattern Number 1 for PATGEN of DAC0"]
    #[inline(always)]
    #[must_use]
    pub fn pat1(&mut self) -> Pat1W<Dac0patlSpec> {
        Pat1W::new(self, 5)
    }
    #[doc = "Bits 10:14 - Pattern Number 2 for PATGEN of DAC0"]
    #[inline(always)]
    #[must_use]
    pub fn pat2(&mut self) -> Pat2W<Dac0patlSpec> {
        Pat2W::new(self, 10)
    }
    #[doc = "Bits 15:19 - Pattern Number 3 for PATGEN of DAC0"]
    #[inline(always)]
    #[must_use]
    pub fn pat3(&mut self) -> Pat3W<Dac0patlSpec> {
        Pat3W::new(self, 15)
    }
    #[doc = "Bits 20:24 - Pattern Number 4 for PATGEN of DAC0"]
    #[inline(always)]
    #[must_use]
    pub fn pat4(&mut self) -> Pat4W<Dac0patlSpec> {
        Pat4W::new(self, 20)
    }
    #[doc = "Bits 25:29 - Pattern Number 5 for PATGEN of DAC0"]
    #[inline(always)]
    #[must_use]
    pub fn pat5(&mut self) -> Pat5W<Dac0patlSpec> {
        Pat5W::new(self, 25)
    }
}
