...
pub struct R(crate::R<DAC0PATL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DAC0PATL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DAC0PATL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DAC0PATL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DAC0PATL` writer"]
pub struct W(crate::W<DAC0PATL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DAC0PATL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DAC0PATL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DAC0PATL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PAT0_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
...
pub type PAT1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
...
pub type PAT2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
...
pub type PAT3_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
...
pub type PAT4_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
...
pub type PAT5_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATL_SPEC, 5, O>;
impl R {
