...
pub type PAT6_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATH_SPEC, 5, O>;
...
pub type PAT7_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATH_SPEC, 5, O>;
...
pub type PAT8_W<'a, const O: u8> = crate::FieldWriter<'a, DAC0PATH_SPEC, 5, O>;
impl R {
