...
pub type PAT0_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
...
pub type PAT1_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
...
pub type PAT2_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
...
pub type PAT3_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
...
pub type PAT4_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
...
pub type PAT5_W<'a, const O: u8> = crate::FieldWriter<'a, DAC1PATL_SPEC, 5, O>;
impl R {
