...
impl W {
    ...
    #[doc = "Bit 4 - Mask bit for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<'_, MASKSRCTRAN_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Mask bit for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<'_, MASKSRCTRAN_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Mask bit for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<'_, MASKSRCTRAN_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Mask bit for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<'_, MASKSRCTRAN_SPEC> {
        CH7_W::new(self, 7)
    }
