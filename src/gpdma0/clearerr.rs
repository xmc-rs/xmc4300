#[doc = "Writer for register CLEARERR"]
pub type W = crate::W<u32, super::CLEARERR>;
#[doc = "Register CLEARERR `reset()`'s with value 0"]
impl crate::ResetValue for super::CLEARERR {
    type Type = u32;
    #[inline(always)]
