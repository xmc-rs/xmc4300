...
pub struct R(crate::R<STATUSDSTTRAN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STATUSDSTTRAN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<STATUSDSTTRAN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<STATUSDSTTRAN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "IntBlock Status\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [statusdsttran](index.html) module"]
pub struct STATUSDSTTRAN_SPEC;
impl crate::RegisterSpec for STATUSDSTTRAN_SPEC {
    type Ux = u32;
}
