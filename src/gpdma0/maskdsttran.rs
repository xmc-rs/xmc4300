...
impl W {
    #[doc = "Bit 0 - Mask bit for channel 0"]
    #[inline(always)]
    pub fn ch0(&mut self) -> CH0_W<'_, MASKDSTTRAN_SPEC> {
        CH0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Mask bit for channel 1"]
    #[inline(always)]
    pub fn ch1(&mut self) -> CH1_W<'_, MASKDSTTRAN_SPEC> {
        CH1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Mask bit for channel 2"]
    #[inline(always)]
    pub fn ch2(&mut self) -> CH2_W<'_, MASKDSTTRAN_SPEC> {
        CH2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Mask bit for channel 3"]
    #[inline(always)]
    pub fn ch3(&mut self) -> CH3_W<'_, MASKDSTTRAN_SPEC> {
        CH3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Mask bit for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<'_, MASKDSTTRAN_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Mask bit for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<'_, MASKDSTTRAN_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Mask bit for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<'_, MASKDSTTRAN_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Mask bit for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<'_, MASKDSTTRAN_SPEC> {
        CH7_W::new(self, 7)
    }
    #[doc = "Bit 8 - Write enable for mask bit of channel 0"]
    #[inline(always)]
    pub fn we_ch0(&mut self) -> WE_CH0_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH0_W::new(self, 8)
    }
    #[doc = "Bit 9 - Write enable for mask bit of channel 1"]
    #[inline(always)]
    pub fn we_ch1(&mut self) -> WE_CH1_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH1_W::new(self, 9)
    }
    #[doc = "Bit 10 - Write enable for mask bit of channel 2"]
    #[inline(always)]
    pub fn we_ch2(&mut self) -> WE_CH2_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH2_W::new(self, 10)
    }
    #[doc = "Bit 11 - Write enable for mask bit of channel 3"]
    #[inline(always)]
    pub fn we_ch3(&mut self) -> WE_CH3_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH3_W::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable for mask bit of channel 4"]
    #[inline(always)]
    pub fn we_ch4(&mut self) -> WE_CH4_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH4_W::new(self, 12)
    }
    #[doc = "Bit 13 - Write enable for mask bit of channel 5"]
    #[inline(always)]
    pub fn we_ch5(&mut self) -> WE_CH5_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH5_W::new(self, 13)
    }
    #[doc = "Bit 14 - Write enable for mask bit of channel 6"]
    #[inline(always)]
    pub fn we_ch6(&mut self) -> WE_CH6_W<'_, MASKDSTTRAN_SPEC> {
        WE_CH6_W::new(self, 14)
    }
    #[doc = "Bit 15 - Write enable for mask bit of channel 7"]
    #[inline(always)]
    pub fn we_ch7(&mut self) -> WE_CH7_W<'_, MASKDSTTRAN_SPEC> {
