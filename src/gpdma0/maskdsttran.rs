...
pub type CH4_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, CH4_A>;
...
pub type CH5_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, CH5_A>;
...
pub type CH6_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, CH6_A>;
...
pub type CH7_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, CH7_A>;
...
pub type WE_CH4_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, WE_CH4_AW>;
...
pub type WE_CH5_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, WE_CH5_AW>;
...
pub type WE_CH6_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, WE_CH6_AW>;
...
pub type WE_CH7_W<'a, const O: u8> = crate::BitWriter<'a, MASKDSTTRAN_SPEC, O, WE_CH7_AW>;
