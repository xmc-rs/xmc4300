...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> Ch4W<ReqdstregSpec> {
        Ch4W::new(self, 4)
    }
    #[doc = "Bit 5 - Source request for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> Ch5W<ReqdstregSpec> {
        Ch5W::new(self, 5)
    }
    #[doc = "Bit 6 - Source request for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> Ch6W<ReqdstregSpec> {
        Ch6W::new(self, 6)
    }
    #[doc = "Bit 7 - Source request for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> Ch7W<ReqdstregSpec> {
        Ch7W::new(self, 7)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn we_ch4(&mut self) -> WeCh4W<ReqdstregSpec> {
        WeCh4W::new(self, 12)
    }
    #[doc = "Bit 13 - Source request write enable for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch5(&mut self) -> WeCh5W<ReqdstregSpec> {
        WeCh5W::new(self, 13)
    }
    #[doc = "Bit 14 - Source request write enable for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch6(&mut self) -> WeCh6W<ReqdstregSpec> {
        WeCh6W::new(self, 14)
    }
    #[doc = "Bit 15 - Source request write enable for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch7(&mut self) -> WeCh7W<ReqdstregSpec> {
        WeCh7W::new(self, 15)
    }
}
