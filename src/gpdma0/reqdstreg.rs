...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<REQDSTREG_SPEC, 4> {
        CH4_W::new(self)
    }
    #[doc = "Bit 5 - Source request for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> CH5_W<REQDSTREG_SPEC, 5> {
        CH5_W::new(self)
    }
    #[doc = "Bit 6 - Source request for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> CH6_W<REQDSTREG_SPEC, 6> {
        CH6_W::new(self)
    }
    #[doc = "Bit 7 - Source request for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> CH7_W<REQDSTREG_SPEC, 7> {
        CH7_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn we_ch4(&mut self) -> WE_CH4_W<REQDSTREG_SPEC, 12> {
        WE_CH4_W::new(self)
    }
    #[doc = "Bit 13 - Source request write enable for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch5(&mut self) -> WE_CH5_W<REQDSTREG_SPEC, 13> {
        WE_CH5_W::new(self)
    }
    #[doc = "Bit 14 - Source request write enable for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch6(&mut self) -> WE_CH6_W<REQDSTREG_SPEC, 14> {
        WE_CH6_W::new(self)
    }
    #[doc = "Bit 15 - Source request write enable for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch7(&mut self) -> WE_CH7_W<REQDSTREG_SPEC, 15> {
        WE_CH7_W::new(self)
    }
