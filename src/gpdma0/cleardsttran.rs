...
pub struct W(crate::W<CLEARDSTTRAN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLEARDSTTRAN_SPEC>;
    #[inline(always)]
...
impl From<crate::W<CLEARDSTTRAN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLEARDSTTRAN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CH0_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH0_AW, O>;
...
pub type CH1_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH1_AW, O>;
...
pub type CH2_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH2_AW, O>;
...
pub type CH3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH3_AW, O>;
...
pub type CH4_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH4_AW, O>;
...
pub type CH5_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH5_AW, O>;
...
pub type CH6_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH6_AW, O>;
...
pub type CH7_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLEARDSTTRAN_SPEC, CH7_AW, O>;
...
#[doc = "IntBlock Status\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cleardsttran](index.html) module"]
