...
impl W {
    ...
    #[doc = "Bit 4 - Source request for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<'_, SGLREQSRCREG_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Source request for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<'_, SGLREQSRCREG_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Source request for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<'_, SGLREQSRCREG_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Source request for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<'_, SGLREQSRCREG_SPEC> {
        CH7_W::new(self, 7)
    }
