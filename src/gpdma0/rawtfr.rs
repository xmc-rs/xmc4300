...
pub type R = crate::R<RawtfrSpec>;
#[doc = "Register `RAWTFR` writer"]
pub type W = crate::W<RawtfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> Ch0W<RawtfrSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Raw Interrupt Status for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> Ch1W<RawtfrSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Raw Interrupt Status for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> Ch2W<RawtfrSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Raw Interrupt Status for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> Ch3W<RawtfrSpec> {
        Ch3W::new(self, 3)
    }
    #[doc = "Bit 4 - Raw Interrupt Status for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> Ch4W<RawtfrSpec> {
        Ch4W::new(self, 4)
    }
    #[doc = "Bit 5 - Raw Interrupt Status for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> Ch5W<RawtfrSpec> {
        Ch5W::new(self, 5)
    }
    #[doc = "Bit 6 - Raw Interrupt Status for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> Ch6W<RawtfrSpec> {
        Ch6W::new(self, 6)
    }
    #[doc = "Bit 7 - Raw Interrupt Status for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> Ch7W<RawtfrSpec> {
        Ch7W::new(self, 7)
    }
}
...
pub struct RawtfrSpec;
impl crate::RegisterSpec for RawtfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rawtfr::R`](R) reader structure"]
impl crate::Readable for RawtfrSpec {}
#[doc = "`write(|w| ..)` method takes [`rawtfr::W`](W) writer structure"]
impl crate::Writable for RawtfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RAWTFR to value 0"]
impl crate::Resettable for RawtfrSpec {
