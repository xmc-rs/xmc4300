...
impl W {
    ...
    #[doc = "Bit 4 - Raw Interrupt Status for channel 4"]
    #[inline(always)]
    pub fn ch4(&mut self) -> CH4_W<'_, RAWTFR_SPEC> {
        CH4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Raw Interrupt Status for channel 5"]
    #[inline(always)]
    pub fn ch5(&mut self) -> CH5_W<'_, RAWTFR_SPEC> {
        CH5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Raw Interrupt Status for channel 6"]
    #[inline(always)]
    pub fn ch6(&mut self) -> CH6_W<'_, RAWTFR_SPEC> {
        CH6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Raw Interrupt Status for channel 7"]
    #[inline(always)]
    pub fn ch7(&mut self) -> CH7_W<'_, RAWTFR_SPEC> {
        CH7_W::new(self, 7)
    }
}
