...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<RAWTFR_SPEC, 4> {
        CH4_W::new(self)
    }
    #[doc = "Bit 5 - Raw Interrupt Status for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> CH5_W<RAWTFR_SPEC, 5> {
        CH5_W::new(self)
    }
    #[doc = "Bit 6 - Raw Interrupt Status for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> CH6_W<RAWTFR_SPEC, 6> {
        CH6_W::new(self)
    }
    #[doc = "Bit 7 - Raw Interrupt Status for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> CH7_W<RAWTFR_SPEC, 7> {
        CH7_W::new(self)
    }
