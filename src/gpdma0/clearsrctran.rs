...
pub type CH0_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH0_AW>;
...
pub type CH1_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH1_AW>;
...
pub type CH2_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH2_AW>;
...
pub type CH3_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH3_AW>;
...
pub type CH4_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH4_AW>;
...
pub type CH5_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH5_AW>;
...
pub type CH6_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH6_AW>;
...
pub type CH7_W<'a, const O: u8> = crate::BitWriter<'a, CLEARSRCTRAN_SPEC, O, CH7_AW>;
