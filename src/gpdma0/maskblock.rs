...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> CH0_W<MASKBLOCK_SPEC, 0> {
        CH0_W::new(self)
    }
    #[doc = "Bit 1 - Mask bit for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> CH1_W<MASKBLOCK_SPEC, 1> {
        CH1_W::new(self)
    }
    #[doc = "Bit 2 - Mask bit for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> CH2_W<MASKBLOCK_SPEC, 2> {
        CH2_W::new(self)
    }
    #[doc = "Bit 3 - Mask bit for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> CH3_W<MASKBLOCK_SPEC, 3> {
        CH3_W::new(self)
    }
    #[doc = "Bit 4 - Mask bit for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> CH4_W<MASKBLOCK_SPEC, 4> {
        CH4_W::new(self)
    }
    #[doc = "Bit 5 - Mask bit for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> CH5_W<MASKBLOCK_SPEC, 5> {
        CH5_W::new(self)
    }
    #[doc = "Bit 6 - Mask bit for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> CH6_W<MASKBLOCK_SPEC, 6> {
        CH6_W::new(self)
    }
    #[doc = "Bit 7 - Mask bit for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> CH7_W<MASKBLOCK_SPEC, 7> {
        CH7_W::new(self)
    }
    #[doc = "Bit 8 - Write enable for mask bit of channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch0(&mut self) -> WE_CH0_W<MASKBLOCK_SPEC, 8> {
        WE_CH0_W::new(self)
    }
    #[doc = "Bit 9 - Write enable for mask bit of channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch1(&mut self) -> WE_CH1_W<MASKBLOCK_SPEC, 9> {
        WE_CH1_W::new(self)
    }
    #[doc = "Bit 10 - Write enable for mask bit of channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch2(&mut self) -> WE_CH2_W<MASKBLOCK_SPEC, 10> {
        WE_CH2_W::new(self)
    }
    #[doc = "Bit 11 - Write enable for mask bit of channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch3(&mut self) -> WE_CH3_W<MASKBLOCK_SPEC, 11> {
        WE_CH3_W::new(self)
    }
    #[doc = "Bit 12 - Write enable for mask bit of channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch4(&mut self) -> WE_CH4_W<MASKBLOCK_SPEC, 12> {
        WE_CH4_W::new(self)
    }
    #[doc = "Bit 13 - Write enable for mask bit of channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch5(&mut self) -> WE_CH5_W<MASKBLOCK_SPEC, 13> {
        WE_CH5_W::new(self)
    }
    #[doc = "Bit 14 - Write enable for mask bit of channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch6(&mut self) -> WE_CH6_W<MASKBLOCK_SPEC, 14> {
        WE_CH6_W::new(self)
    }
    #[doc = "Bit 15 - Write enable for mask bit of channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch7(&mut self) -> WE_CH7_W<MASKBLOCK_SPEC, 15> {
        WE_CH7_W::new(self)
    }
