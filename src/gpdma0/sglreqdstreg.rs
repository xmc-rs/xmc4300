...
pub struct R(crate::R<SGLREQDSTREG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SGLREQDSTREG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SGLREQDSTREG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SGLREQDSTREG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SGLREQDSTREG` writer"]
pub struct W(crate::W<SGLREQDSTREG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SGLREQDSTREG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SGLREQDSTREG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SGLREQDSTREG_SPEC>) -> Self {
        W(writer)
    }
}
