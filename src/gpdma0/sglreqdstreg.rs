...
pub type R = crate::R<SglreqdstregSpec>;
#[doc = "Register `SGLREQDSTREG` writer"]
pub type W = crate::W<SglreqdstregSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> Ch0W<SglreqdstregSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Source request for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> Ch1W<SglreqdstregSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Source request for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> Ch2W<SglreqdstregSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Source request for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> Ch3W<SglreqdstregSpec> {
        Ch3W::new(self, 3)
    }
    #[doc = "Bit 4 - Source request for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> Ch4W<SglreqdstregSpec> {
        Ch4W::new(self, 4)
    }
    #[doc = "Bit 5 - Source request for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> Ch5W<SglreqdstregSpec> {
        Ch5W::new(self, 5)
    }
    #[doc = "Bit 6 - Source request for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> Ch6W<SglreqdstregSpec> {
        Ch6W::new(self, 6)
    }
    #[doc = "Bit 7 - Source request for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> Ch7W<SglreqdstregSpec> {
        Ch7W::new(self, 7)
    }
    #[doc = "Bit 8 - Source request write enable for channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch0(&mut self) -> WeCh0W<SglreqdstregSpec> {
        WeCh0W::new(self, 8)
    }
    #[doc = "Bit 9 - Source request write enable for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch1(&mut self) -> WeCh1W<SglreqdstregSpec> {
        WeCh1W::new(self, 9)
    }
    #[doc = "Bit 10 - Source request write enable for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch2(&mut self) -> WeCh2W<SglreqdstregSpec> {
        WeCh2W::new(self, 10)
    }
    #[doc = "Bit 11 - Source request write enable for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch3(&mut self) -> WeCh3W<SglreqdstregSpec> {
        WeCh3W::new(self, 11)
    }
    #[doc = "Bit 12 - Source request write enable for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch4(&mut self) -> WeCh4W<SglreqdstregSpec> {
        WeCh4W::new(self, 12)
    }
    #[doc = "Bit 13 - Source request write enable for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch5(&mut self) -> WeCh5W<SglreqdstregSpec> {
        WeCh5W::new(self, 13)
    }
    #[doc = "Bit 14 - Source request write enable for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch6(&mut self) -> WeCh6W<SglreqdstregSpec> {
        WeCh6W::new(self, 14)
    }
    #[doc = "Bit 15 - Source request write enable for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch7(&mut self) -> WeCh7W<SglreqdstregSpec> {
        WeCh7W::new(self, 15)
    }
}
...
pub struct SglreqdstregSpec;
impl crate::RegisterSpec for SglreqdstregSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sglreqdstreg::R`](R) reader structure"]
impl crate::Readable for SglreqdstregSpec {}
#[doc = "`write(|w| ..)` method takes [`sglreqdstreg::W`](W) writer structure"]
impl crate::Writable for SglreqdstregSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets SGLREQDSTREG to value 0"]
impl crate::Resettable for SglreqdstregSpec {
