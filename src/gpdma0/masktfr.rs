...
pub type R = crate::R<MasktfrSpec>;
#[doc = "Register `MASKTFR` writer"]
pub type W = crate::W<MasktfrSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0(&mut self) -> Ch0W<MasktfrSpec> {
        Ch0W::new(self, 0)
    }
    #[doc = "Bit 1 - Mask bit for channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1(&mut self) -> Ch1W<MasktfrSpec> {
        Ch1W::new(self, 1)
    }
    #[doc = "Bit 2 - Mask bit for channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn ch2(&mut self) -> Ch2W<MasktfrSpec> {
        Ch2W::new(self, 2)
    }
    #[doc = "Bit 3 - Mask bit for channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn ch3(&mut self) -> Ch3W<MasktfrSpec> {
        Ch3W::new(self, 3)
    }
    #[doc = "Bit 4 - Mask bit for channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn ch4(&mut self) -> Ch4W<MasktfrSpec> {
        Ch4W::new(self, 4)
    }
    #[doc = "Bit 5 - Mask bit for channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn ch5(&mut self) -> Ch5W<MasktfrSpec> {
        Ch5W::new(self, 5)
    }
    #[doc = "Bit 6 - Mask bit for channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn ch6(&mut self) -> Ch6W<MasktfrSpec> {
        Ch6W::new(self, 6)
    }
    #[doc = "Bit 7 - Mask bit for channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn ch7(&mut self) -> Ch7W<MasktfrSpec> {
        Ch7W::new(self, 7)
    }
    #[doc = "Bit 8 - Write enable for mask bit of channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch0(&mut self) -> WeCh0W<MasktfrSpec> {
        WeCh0W::new(self, 8)
    }
    #[doc = "Bit 9 - Write enable for mask bit of channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch1(&mut self) -> WeCh1W<MasktfrSpec> {
        WeCh1W::new(self, 9)
    }
    #[doc = "Bit 10 - Write enable for mask bit of channel 2"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch2(&mut self) -> WeCh2W<MasktfrSpec> {
        WeCh2W::new(self, 10)
    }
    #[doc = "Bit 11 - Write enable for mask bit of channel 3"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch3(&mut self) -> WeCh3W<MasktfrSpec> {
        WeCh3W::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable for mask bit of channel 4"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch4(&mut self) -> WeCh4W<MasktfrSpec> {
        WeCh4W::new(self, 12)
    }
    #[doc = "Bit 13 - Write enable for mask bit of channel 5"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch5(&mut self) -> WeCh5W<MasktfrSpec> {
        WeCh5W::new(self, 13)
    }
    #[doc = "Bit 14 - Write enable for mask bit of channel 6"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch6(&mut self) -> WeCh6W<MasktfrSpec> {
        WeCh6W::new(self, 14)
    }
    #[doc = "Bit 15 - Write enable for mask bit of channel 7"]
    #[inline(always)]
    #[must_use]
    pub fn we_ch7(&mut self) -> WeCh7W<MasktfrSpec> {
        WeCh7W::new(self, 15)
    }
}
...
pub struct MasktfrSpec;
impl crate::RegisterSpec for MasktfrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`masktfr::R`](R) reader structure"]
impl crate::Readable for MasktfrSpec {}
#[doc = "`write(|w| ..)` method takes [`masktfr::W`](W) writer structure"]
impl crate::Writable for MasktfrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MASKTFR to value 0"]
impl crate::Resettable for MasktfrSpec {
