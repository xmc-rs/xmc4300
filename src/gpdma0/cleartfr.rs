#[doc = "Writer for register CLEARTFR"]
pub type W = crate::W<u32, super::CLEARTFR>;
#[doc = "Register CLEARTFR `reset()`'s with value 0"]
impl crate::ResetValue for super::CLEARTFR {
    type Type = u32;
    #[inline(always)]
