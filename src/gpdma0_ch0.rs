...
pub mod sstat;
#[doc = "DSTAT (rw) register accessor: an alias for `Reg<DSTAT_SPEC>`"]
pub type DSTAT = crate::Reg<dstat::DSTAT_SPEC>;
#[doc = "Destination Status Register"]
pub mod dstat;
#[doc = "SSTATAR (rw) register accessor: an alias for `Reg<SSTATAR_SPEC>`"]
pub type SSTATAR = crate::Reg<sstatar::SSTATAR_SPEC>;
#[doc = "Source Status Address Register"]
pub mod sstatar;
#[doc = "DSTATAR (rw) register accessor: an alias for `Reg<DSTATAR_SPEC>`"]
...
pub mod cfgh;
#[doc = "SGR (rw) register accessor: an alias for `Reg<SGR_SPEC>`"]
