...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdtrs(&mut self) -> WDTRS_W<PRSET2_SPEC, 1> {
        WDTRS_W::new(self)
    }
    #[doc = "Bit 2 - ETH0 Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn eth0rs(&mut self) -> ETH0RS_W<PRSET2_SPEC, 2> {
        ETH0RS_W::new(self)
    }
    #[doc = "Bit 4 - DMA0 Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn dma0rs(&mut self) -> DMA0RS_W<PRSET2_SPEC, 4> {
        DMA0RS_W::new(self)
    }
    #[doc = "Bit 6 - FCE Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn fcers(&mut self) -> FCERS_W<PRSET2_SPEC, 6> {
        FCERS_W::new(self)
    }
    #[doc = "Bit 7 - USB Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn usbrs(&mut self) -> USBRS_W<PRSET2_SPEC, 7> {
        USBRS_W::new(self)
    }
    #[doc = "Bit 10 - ECAT0 Reset Assert"]
    #[inline(always)]
    #[must_use]
    pub fn ecat0rs(&mut self) -> ECAT0RS_W<PRSET2_SPEC, 10> {
        ECAT0RS_W::new(self)
    }
