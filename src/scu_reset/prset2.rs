...
pub type WDTRS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, WDTRS_AW>;
...
pub type ETH0RS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, ETH0RS_AW>;
...
pub type DMA0RS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, DMA0RS_AW>;
...
pub type FCERS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, FCERS_AW>;
...
pub type USBRS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, USBRS_AW>;
...
pub type ECAT0RS_W<'a, const O: u8> = crate::BitWriter<'a, PRSET2_SPEC, O, ECAT0RS_AW>;
