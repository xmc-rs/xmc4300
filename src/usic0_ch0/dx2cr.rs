...
pub type R = crate::R<Dx2crSpec>;
#[doc = "Register `DX2CR` writer"]
pub type W = crate::W<Dx2crSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsel(&mut self) -> DselW<Dx2crSpec> {
        DselW::new(self, 0)
    }
    #[doc = "Bit 4 - Input Switch"]
    #[inline(always)]
    #[must_use]
    pub fn insw(&mut self) -> InswW<Dx2crSpec> {
        InswW::new(self, 4)
    }
    #[doc = "Bit 5 - Digital Filter Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DfenW<Dx2crSpec> {
        DfenW::new(self, 5)
    }
    #[doc = "Bit 6 - Data Synchronization Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsen(&mut self) -> DsenW<Dx2crSpec> {
        DsenW::new(self, 6)
    }
    #[doc = "Bit 8 - Data Polarity for DXn"]
    #[inline(always)]
    #[must_use]
    pub fn dpol(&mut self) -> DpolW<Dx2crSpec> {
        DpolW::new(self, 8)
    }
    #[doc = "Bit 9 - Sampling Frequency Selection"]
    #[inline(always)]
    #[must_use]
    pub fn sfsel(&mut self) -> SfselW<Dx2crSpec> {
        SfselW::new(self, 9)
    }
    #[doc = "Bits 10:11 - Combination Mode"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CmW<Dx2crSpec> {
        CmW::new(self, 10)
    }
}
...
pub struct Dx2crSpec;
impl crate::RegisterSpec for Dx2crSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dx2cr::R`](R) reader structure"]
impl crate::Readable for Dx2crSpec {}
#[doc = "`write(|w| ..)` method takes [`dx2cr::W`](W) writer structure"]
impl crate::Writable for Dx2crSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DX2CR to value 0"]
impl crate::Resettable for Dx2crSpec {
