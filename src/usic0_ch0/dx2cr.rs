...
pub type DSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, DX2CR_SPEC, u8, DSEL_A, 3, O>;
...
pub type INSW_W<'a, const O: u8> = crate::BitWriter<'a, u32, DX2CR_SPEC, INSW_A, O>;
...
pub type DFEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DX2CR_SPEC, DFEN_A, O>;
...
pub type DSEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, DX2CR_SPEC, DSEN_A, O>;
...
pub type DPOL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DX2CR_SPEC, DPOL_A, O>;
...
pub type SFSEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, DX2CR_SPEC, SFSEL_A, O>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, DX2CR_SPEC, u8, CM_A, 2, O>;
