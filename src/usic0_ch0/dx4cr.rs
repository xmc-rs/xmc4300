...
impl W {
    #[doc = "Bits 0:2 - Data Selection for Input Signal"]
    #[inline(always)]
    pub fn dsel(&mut self) -> DSEL_W<'_, DX4CR_SPEC> {
        DSEL_W::new(self, 0)
    }
    #[doc = "Bit 4 - Input Switch"]
    #[inline(always)]
    pub fn insw(&mut self) -> INSW_W<'_, DX4CR_SPEC> {
        INSW_W::new(self, 4)
    }
    #[doc = "Bit 5 - Digital Filter Enable"]
    #[inline(always)]
    pub fn dfen(&mut self) -> DFEN_W<'_, DX4CR_SPEC> {
        DFEN_W::new(self, 5)
    }
    #[doc = "Bit 6 - Data Synchronization Enable"]
    #[inline(always)]
    pub fn dsen(&mut self) -> DSEN_W<'_, DX4CR_SPEC> {
        DSEN_W::new(self, 6)
    }
    #[doc = "Bit 8 - Data Polarity for DXn"]
    #[inline(always)]
    pub fn dpol(&mut self) -> DPOL_W<'_, DX4CR_SPEC> {
        DPOL_W::new(self, 8)
    }
    #[doc = "Bit 9 - Sampling Frequency Selection"]
    #[inline(always)]
    pub fn sfsel(&mut self) -> SFSEL_W<'_, DX4CR_SPEC> {
        SFSEL_W::new(self, 9)
    }
    #[doc = "Bits 10:11 - Combination Mode"]
    #[inline(always)]
    pub fn cm(&mut self) -> CM_W<'_, DX4CR_SPEC> {
        CM_W::new(self, 10)
    }
}
