...
pub struct R(crate::R<DX1CR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DX1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DX1CR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DX1CR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DX1CR` writer"]
pub struct W(crate::W<DX1CR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DX1CR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DX1CR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DX1CR_SPEC>) -> Self {
        W(writer)
    }
}
