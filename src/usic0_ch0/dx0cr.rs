...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dsel(&mut self) -> DSEL_W<DX0CR_SPEC, 0> {
        DSEL_W::new(self)
    }
    #[doc = "Bit 4 - Input Switch"]
    #[inline(always)]
    #[must_use]
    pub fn insw(&mut self) -> INSW_W<DX0CR_SPEC, 4> {
        INSW_W::new(self)
    }
    #[doc = "Bit 5 - Digital Filter Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dfen(&mut self) -> DFEN_W<DX0CR_SPEC, 5> {
        DFEN_W::new(self)
    }
    #[doc = "Bit 6 - Data Synchronization Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dsen(&mut self) -> DSEN_W<DX0CR_SPEC, 6> {
        DSEN_W::new(self)
    }
    #[doc = "Bit 8 - Data Polarity for DXn"]
    #[inline(always)]
    #[must_use]
    pub fn dpol(&mut self) -> DPOL_W<DX0CR_SPEC, 8> {
        DPOL_W::new(self)
    }
    #[doc = "Bit 9 - Sampling Frequency Selection"]
    #[inline(always)]
    #[must_use]
    pub fn sfsel(&mut self) -> SFSEL_W<DX0CR_SPEC, 9> {
        SFSEL_W::new(self)
    }
    #[doc = "Bits 10:11 - Combination Mode"]
    #[inline(always)]
    #[must_use]
    pub fn cm(&mut self) -> CM_W<DX0CR_SPEC, 10> {
        CM_W::new(self)
    }
