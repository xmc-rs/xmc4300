...
pub type R = crate::R<BypSpec>;
#[doc = "Register `BYP` writer"]
pub type W = crate::W<BypSpec>;
#[doc = "Field `BDATA` reader - Bypass Data"]
pub type BdataR = crate::FieldReader<u16>;
#[doc = "Field `BDATA` writer - Bypass Data"]
pub type BdataW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
impl R {
    #[doc = "Bits 0:15 - Bypass Data"]
    #[inline(always)]
    pub fn bdata(&self) -> BdataR {
        BdataR::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Bypass Data"]
    #[inline(always)]
    #[must_use]
    pub fn bdata(&mut self) -> BdataW<BypSpec> {
        BdataW::new(self, 0)
    }
}
