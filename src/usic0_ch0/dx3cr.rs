...
pub type DSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DX3CR_SPEC, 3, O, DSEL_A>;
...
pub type INSW_W<'a, const O: u8> = crate::BitWriter<'a, DX3CR_SPEC, O, INSW_A>;
...
pub type DFEN_W<'a, const O: u8> = crate::BitWriter<'a, DX3CR_SPEC, O, DFEN_A>;
...
pub type DSEN_W<'a, const O: u8> = crate::BitWriter<'a, DX3CR_SPEC, O, DSEN_A>;
...
pub type DPOL_W<'a, const O: u8> = crate::BitWriter<'a, DX3CR_SPEC, O, DPOL_A>;
...
pub type SFSEL_W<'a, const O: u8> = crate::BitWriter<'a, DX3CR_SPEC, O, SFSEL_A>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, DX3CR_SPEC, 2, O, CM_A>;
