...
impl W {
    ...
    #[inline(always)]
    pub fn wdt(&mut self) -> WDT_W<'_, CGATCLR2_SPEC> {
        WDT_W::new(self, 1)
    }
    #[doc = "Bit 2 - ETH0 Gating Clear"]
    #[inline(always)]
    pub fn eth0(&mut self) -> ETH0_W<'_, CGATCLR2_SPEC> {
        ETH0_W::new(self, 2)
    }
    #[doc = "Bit 4 - DMA0 Gating Clear"]
    #[inline(always)]
    pub fn dma0(&mut self) -> DMA0_W<'_, CGATCLR2_SPEC> {
        DMA0_W::new(self, 4)
    }
    #[doc = "Bit 6 - FCE Gating Clear"]
    #[inline(always)]
    pub fn fce(&mut self) -> FCE_W<'_, CGATCLR2_SPEC> {
        FCE_W::new(self, 6)
    }
    #[doc = "Bit 7 - USB Gating Clear"]
    #[inline(always)]
    pub fn usb(&mut self) -> USB_W<'_, CGATCLR2_SPEC> {
        USB_W::new(self, 7)
    }
    #[doc = "Bit 10 - ECAT0 Gating Clear"]
    #[inline(always)]
    pub fn ecat0(&mut self) -> ECAT0_W<'_, CGATCLR2_SPEC> {
        ECAT0_W::new(self, 10)
    }
}
