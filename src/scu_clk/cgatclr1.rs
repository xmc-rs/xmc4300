...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ledtscu0(&mut self) -> LEDTSCU0_W<CGATCLR1_SPEC, 3> {
        LEDTSCU0_W::new(self)
    }
    #[doc = "Bit 4 - MultiCAN Gating Clear"]
    #[inline(always)]
    #[must_use]
    pub fn mcan0(&mut self) -> MCAN0_W<CGATCLR1_SPEC, 4> {
        MCAN0_W::new(self)
    }
    #[doc = "Bit 5 - DAC Gating Clear"]
    #[inline(always)]
    #[must_use]
    pub fn dac(&mut self) -> DAC_W<CGATCLR1_SPEC, 5> {
        DAC_W::new(self)
    }
    #[doc = "Bit 6 - MMC Interface Gating Clear"]
    #[inline(always)]
    #[must_use]
    pub fn mmci(&mut self) -> MMCI_W<CGATCLR1_SPEC, 6> {
        MMCI_W::new(self)
    }
    #[doc = "Bit 7 - USIC1 Gating Clear"]
    #[inline(always)]
    #[must_use]
    pub fn usic1(&mut self) -> USIC1_W<CGATCLR1_SPEC, 7> {
        USIC1_W::new(self)
    }
    #[doc = "Bit 9 - PORTS Gating Clear"]
    #[inline(always)]
    #[must_use]
    pub fn pports(&mut self) -> PPORTS_W<CGATCLR1_SPEC, 9> {
        PPORTS_W::new(self)
    }
