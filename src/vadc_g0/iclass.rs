...
pub type R = crate::R<IclassSpec>;
#[doc = "Register `ICLASS[%s]` writer"]
pub type W = crate::W<IclassSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stcs(&mut self) -> StcsW<IclassSpec> {
        StcsW::new(self, 0)
    }
    #[doc = "Bits 8:10 - Conversion Mode for Standard Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn cms(&mut self) -> CmsW<IclassSpec> {
        CmsW::new(self, 8)
    }
    #[doc = "Bits 16:20 - Sample Time Control for EMUX Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn stce(&mut self) -> StceW<IclassSpec> {
        StceW::new(self, 16)
    }
    #[doc = "Bits 24:26 - Conversion Mode for EMUX Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn cme(&mut self) -> CmeW<IclassSpec> {
        CmeW::new(self, 24)
    }
}
...
pub struct IclassSpec;
impl crate::RegisterSpec for IclassSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`iclass::R`](R) reader structure"]
impl crate::Readable for IclassSpec {}
#[doc = "`write(|w| ..)` method takes [`iclass::W`](W) writer structure"]
impl crate::Writable for IclassSpec {
...
to value 0"]
impl crate::Resettable for IclassSpec {
