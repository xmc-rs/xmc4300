...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn stcs(&mut self) -> STCS_W<ICLASS_SPEC, 0> {
        STCS_W::new(self)
    }
    #[doc = "Bits 8:10 - Conversion Mode for Standard Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn cms(&mut self) -> CMS_W<ICLASS_SPEC, 8> {
        CMS_W::new(self)
    }
    #[doc = "Bits 16:20 - Sample Time Control for EMUX Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn stce(&mut self) -> STCE_W<ICLASS_SPEC, 16> {
        STCE_W::new(self)
    }
    #[doc = "Bits 24:26 - Conversion Mode for EMUX Conversions"]
    #[inline(always)]
    #[must_use]
    pub fn cme(&mut self) -> CME_W<ICLASS_SPEC, 24> {
        CME_W::new(self)
    }
