...
pub type STCS_W<'a, const O: u8> = crate::FieldWriter<'a, ICLASS_SPEC, 5, O>;
...
pub type CMS_W<'a, const O: u8> = crate::FieldWriter<'a, ICLASS_SPEC, 3, O, CMS_A>;
...
pub type STCE_W<'a, const O: u8> = crate::FieldWriter<'a, ICLASS_SPEC, 5, O>;
...
pub type CME_W<'a, const O: u8> = crate::FieldWriter<'a, ICLASS_SPEC, 3, O, CME_A>;
