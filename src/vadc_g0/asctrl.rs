#[doc = "Reader of register ASCTRL"]
pub type R = crate::R<u32, super::ASCTRL>;
#[doc = "Writer for register ASCTRL"]
pub type W = crate::W<u32, super::ASCTRL>;
#[doc = "Register ASCTRL `reset()`'s with value 0"]
impl crate::ResetValue for super::ASCTRL {
    type Type = u32;
    #[inline(always)]
...
impl From<SRCRESREG_A> for u8 {
    ...
    fn from(variant: SRCRESREG_A) -> Self {
        match variant {
            SRCRESREG_A::VALUE1 => 0,
            SRCRESREG_A::VALUE2 => 1,
            SRCRESREG_A::VALUE3 => 15,
        }
    }
}
...
impl From<TMWC_AW> for bool {
    ...
    fn from(variant: TMWC_AW) -> Self {
        match variant {
            TMWC_AW::VALUE1 => false,
            TMWC_AW::VALUE2 => true,
        }
    }
}
#[doc = "Write proxy for field `TMWC`"]
pub struct TMWC_W<'a> {
    w: &'a mut W,
}
impl<'a> TMWC_W<'a> {
