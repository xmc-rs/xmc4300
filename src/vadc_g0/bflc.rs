...
impl W {
    #[doc = "Bits 0:3 - Boundary Flag y Mode Control"]
    #[inline(always)]
    pub fn bfm0(&mut self) -> BFM0_W<'_, BFLC_SPEC> {
        BFM0_W::new(self, 0)
    }
    #[doc = "Bits 4:7 - Boundary Flag y Mode Control"]
    #[inline(always)]
    pub fn bfm1(&mut self) -> BFM1_W<'_, BFLC_SPEC> {
        BFM1_W::new(self, 4)
    }
    #[doc = "Bits 8:11 - Boundary Flag y Mode Control"]
    #[inline(always)]
    pub fn bfm2(&mut self) -> BFM2_W<'_, BFLC_SPEC> {
        BFM2_W::new(self, 8)
    }
    #[doc = "Bits 12:15 - Boundary Flag y Mode Control"]
    #[inline(always)]
    pub fn bfm3(&mut self) -> BFM3_W<'_, BFLC_SPEC> {
        BFM3_W::new(self, 12)
    }
}
#[doc = "Boundary Flag Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`bflc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bflc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
