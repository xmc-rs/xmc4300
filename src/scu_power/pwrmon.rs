...
pub type THRS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
#[doc = "Field `INTV` reader - Interval"]
pub type INTV_R = crate::FieldReader;
#[doc = "Field `INTV` writer - Interval"]
pub type INTV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn thrs(&mut self) -> THRS_W<PWRMON_SPEC, 0> {
        THRS_W::new(self)
    }
    #[doc = "Bits 8:15 - Interval"]
    #[inline(always)]
    #[must_use]
    pub fn intv(&mut self) -> INTV_W<PWRMON_SPEC, 8> {
        INTV_W::new(self)
    }
    #[doc = "Bit 16 - Enable"]
    #[inline(always)]
    #[must_use]
    pub fn enb(&mut self) -> ENB_W<PWRMON_SPEC, 16> {
        ENB_W::new(self)
    }
