...
#[doc = "BLOCK_SIZE (rw) register accessor: an alias for `Reg<BLOCK_SIZE_SPEC>`"]
pub type BLOCK_SIZE = crate::Reg<block_size::BLOCK_SIZE_SPEC>;
#[doc = "Block Size Register"]
pub mod block_size;
#[doc = "BLOCK_COUNT (rw) register accessor: an alias for `Reg<BLOCK_COUNT_SPEC>`"]
pub type BLOCK_COUNT = crate::Reg<block_count::BLOCK_COUNT_SPEC>;
#[doc = "Block Count Register"]
pub mod block_count;
#[doc = "ARGUMENT1 (rw) register accessor: an alias for `Reg<ARGUMENT1_SPEC>`"]
pub type ARGUMENT1 = crate::Reg<argument1::ARGUMENT1_SPEC>;
#[doc = "Argument1 Register"]
pub mod argument1;
#[doc = "TRANSFER_MODE (rw) register accessor: an alias for `Reg<TRANSFER_MODE_SPEC>`"]
...
pub mod power_ctrl;
#[doc = "BLOCK_GAP_CTRL (rw) register accessor: an alias for `Reg<BLOCK_GAP_CTRL_SPEC>`"]
pub type BLOCK_GAP_CTRL = crate::Reg<block_gap_ctrl::BLOCK_GAP_CTRL_SPEC>;
#[doc = "Block Gap Control Register"]
pub mod block_gap_ctrl;
#[doc = "WAKEUP_CTRL (rw) register accessor: an alias for `Reg<WAKEUP_CTRL_SPEC>`"]
...
pub mod clock_ctrl;
#[doc = "TIMEOUT_CTRL (rw) register accessor: an alias for `Reg<TIMEOUT_CTRL_SPEC>`"]
pub type TIMEOUT_CTRL = crate::Reg<timeout_ctrl::TIMEOUT_CTRL_SPEC>;
#[doc = "Timeout Control Register"]
pub mod timeout_ctrl;
#[doc = "SW_RESET (rw) register accessor: an alias for `Reg<SW_RESET_SPEC>`"]
pub type SW_RESET = crate::Reg<sw_reset::SW_RESET_SPEC>;
#[doc = "Software Reset Register"]
pub mod sw_reset;
#[doc = "INT_STATUS_NORM (rw) register accessor: an alias for `Reg<INT_STATUS_NORM_SPEC>`"]
...
#[doc = "INT_STATUS_ERR (rw) register accessor: an alias for `Reg<INT_STATUS_ERR_SPEC>`"]
...
#[doc = "EN_INT_STATUS_NORM (rw) register accessor: an alias for `Reg<EN_INT_STATUS_NORM_SPEC>`"]
...
#[doc = "EN_INT_STATUS_ERR (rw) register accessor: an alias for `Reg<EN_INT_STATUS_ERR_SPEC>`"]
...
#[doc = "EN_INT_SIGNAL_NORM (rw) register accessor: an alias for `Reg<EN_INT_SIGNAL_NORM_SPEC>`"]
...
#[doc = "EN_INT_SIGNAL_ERR (rw) register accessor: an alias for `Reg<EN_INT_SIGNAL_ERR_SPEC>`"]
...
#[doc = "ACMD_ERR_STATUS (r) register accessor: an alias for `Reg<ACMD_ERR_STATUS_SPEC>`"]
...
#[doc = "CAPABILITIES (r) register accessor: an alias for `Reg<CAPABILITIES_SPEC>`"]
pub type CAPABILITIES = crate::Reg<capabilities::CAPABILITIES_SPEC>;
#[doc = "Capabilities Register"]
pub mod capabilities;
#[doc = "CAPABILITIES_HI (r) register accessor: an alias for `Reg<CAPABILITIES_HI_SPEC>`"]
...
#[doc = "MAX_CURRENT_CAP (r) register accessor: an alias for `Reg<MAX_CURRENT_CAP_SPEC>`"]
...
#[doc = "FORCE_EVENT_ACMD_ERR_STATUS (w) register accessor: an alias for `Reg<FORCE_EVENT_ACMD_ERR_STATUS_SPEC>`"]
...
#[doc = "FORCE_EVENT_ERR_STATUS (w) register accessor: an alias for `Reg<FORCE_EVENT_ERR_STATUS_SPEC>`"]
...
#[doc = "DEBUG_SEL (w) register accessor: an alias for `Reg<DEBUG_SEL_SPEC>`"]
pub type DEBUG_SEL = crate::Reg<debug_sel::DEBUG_SEL_SPEC>;
#[doc = "Debug Selection Register"]
pub mod debug_sel;
#[doc = "SLOT_INT_STATUS (r) register accessor: an alias for `Reg<SLOT_INT_STATUS_SPEC>`"]
