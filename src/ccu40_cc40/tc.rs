...
pub type TRAPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, TC_SPEC, TRAPE_A, O>;
...
pub type MCME_W<'a, const O: u8> = crate::BitWriter<'a, u32, TC_SPEC, MCME_A, O>;
impl<'a, const O: u8> MCME_W<'a, O> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn trape(&mut self) -> TRAPE_W<17> {
        TRAPE_W::new(self)
    }
    #[doc = "Bit 21 - TRAP Synchronization Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn mcme(&mut self) -> MCME_W<25> {
        MCME_W::new(self)
    }
