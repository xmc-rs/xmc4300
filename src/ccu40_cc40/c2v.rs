...
#[doc = "Capture Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c2v::R`](R). WARN: One or more dependent resources other than the current register are immediately affected by a read operation. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C2vSpec;
impl crate::RegisterSpec for C2vSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c2v::R`](R) reader structure"]
impl crate::Readable for C2vSpec {}
#[doc = "`reset()` method sets C2V to value 0"]
impl crate::Resettable for C2vSpec {
