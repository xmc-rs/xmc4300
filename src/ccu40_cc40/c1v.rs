...
#[doc = "Capture Register 1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c1v::R`](R). WARN: One or more dependent resources other than the current register are immediately affected by a read operation. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C1vSpec;
impl crate::RegisterSpec for C1vSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c1v::R`](R) reader structure"]
impl crate::Readable for C1vSpec {}
#[doc = "`reset()` method sets C1V to value 0"]
impl crate::Resettable for C1vSpec {
