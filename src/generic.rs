...
impl<REG: Readable> Reg<REG> {
    ...
    pub fn read(&self) -> REG::Reader {
        REG::Reader::from(R { bits: self.register.get(), _reg: marker::PhantomData })
    }
}
impl<REG: Resettable + Writable> Reg<REG> {
    ...
    {
        self.register.set(f(&mut REG::Writer::from(W { bits: REG::RESET_VALUE & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData })).bits);
    }
}
impl<REG: Writable> Reg<REG> {
    ...
    where
        F: FnOnce(&mut REG::Writer) -> &mut W<REG>,
    {
        self.register.set(f(&mut REG::Writer::from(W { bits: REG::Ux::default(), _reg: marker::PhantomData })).bits);
    }
}
impl<REG: Readable + Writable> Reg<REG> {
        ...
        for<'w> F: FnOnce(&REG::Reader, &'w mut REG::Writer) -> &'w mut W<REG>,
    {
        ...
        self.register.set(f(&REG::Reader::from(R { bits, _reg: marker::PhantomData }), &mut REG::Writer::from(W { bits: bits & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData })).bits);
    }
}
#[doc = " Register reader."]
#[doc = ""]
    ...
    FI: FieldSpec,
{
    ...
    pub(crate) fn new(w: &'a mut REG::Writer) -> Self {
        Self { w, _field: marker::PhantomData }
    }
}
#[doc(hidden)]
...
pub type FieldWriter<'a, REG, const WI: u8, const O: u8, FI = u8> = FieldWriterRaw<'a, REG, WI, O, FI, Unsafe>;
