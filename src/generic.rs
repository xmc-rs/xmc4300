...
impl<REG: Resettable + Writable> Reg<REG> {
    ...
    {
        self.register.set(f(&mut REG::Writer::from(W { bits: REG::reset_value(), _reg: marker::PhantomData })).bits);
    }
}
...
impl<REG: Readable + Writable> Reg<REG> {
        ...
        for<'w> F: FnOnce(&REG::Reader, &'w mut REG::Writer) -> &'w mut W<REG>,
    {
        ...
        self.register.set(f(&REG::Reader::from(R { bits, _reg: marker::PhantomData }), &mut REG::Writer::from(W { bits, _reg: marker::PhantomData })).bits);
    }
}
#[doc = " Register reader."]
#[doc = ""]
