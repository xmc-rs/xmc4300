...
pub trait RawReg: Copy + Default + From<bool> + core::ops::BitOr<Output = Self> + core::ops::BitAnd<Output = Self> + core::ops::BitOrAssign + core::ops::BitAndAssign + core::ops::Not<Output = Self> + core::ops::Shl<u8, Output = Self> {
...
impl<REG: Resettable + Writable> Reg<REG> {
    ...
    {
        let value = f(&mut W { bits: REG::RESET_VALUE & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData }).bits;
    ...
    {
        let mut writer = W { bits: REG::RESET_VALUE & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData };
...
impl<REG: Writable> Reg<REG> {
    ...
    where
        F: FnOnce(&mut W<REG>) -> &mut W<REG>,
    {
        let value = f(&mut W { bits: REG::Ux::default(), _reg: marker::PhantomData }).bits;
        self.register.set(value);
        value
    }
    ...
    where
        F: FnOnce(&mut W<REG>) -> T,
    {
        let mut writer = W { bits: REG::Ux::default(), _reg: marker::PhantomData };
        let result = f(&mut writer);
        self.register.set(writer.bits);
        result
    }
...
impl<REG: Readable + Writable> Reg<REG> {
        ...
        for<'w> F: FnOnce(&R<REG>, &'w mut W<REG>) -> &'w mut W<REG>,
    {
        ...
        let value = f(&R { bits, _reg: marker::PhantomData }, &mut W { bits: bits & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData }).bits;
        self.register.set(value);
        value
    }
    #[doc = " Modifies the contents of the register by reading and then writing it"]
    ...
    {
        let bits = self.register.get();
        let mut writer = W { bits: bits & !REG::ONE_TO_MODIFY_FIELDS_BITMAP | REG::ZERO_TO_MODIFY_FIELDS_BITMAP, _reg: marker::PhantomData };
        let result = f(&R { bits, _reg: marker::PhantomData }, &mut writer);
        self.register.set(writer.bits);
        result
    }
}
