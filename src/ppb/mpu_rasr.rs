...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn b(&mut self) -> B_W<MPU_RASR_SPEC, 16> {
        B_W::new(self)
    }
    #[doc = "Bit 17 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn c(&mut self) -> C_W<MPU_RASR_SPEC, 17> {
        C_W::new(self)
    }
    #[doc = "Bit 18 - Shareable bit"]
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<MPU_RASR_SPEC, 18> {
        S_W::new(self)
    }
    #[doc = "Bits 19:21 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn tex(&mut self) -> TEX_W<MPU_RASR_SPEC, 19> {
        TEX_W::new(self)
    }
    #[doc = "Bits 24:26 - Access permission field"]
    #[inline(always)]
    #[must_use]
    pub fn ap(&mut self) -> AP_W<MPU_RASR_SPEC, 24> {
        AP_W::new(self)
    }
    #[doc = "Bit 28 - Instruction access disable bit"]
    #[inline(always)]
    #[must_use]
    pub fn xn(&mut self) -> XN_W<MPU_RASR_SPEC, 28> {
        XN_W::new(self)
    }
