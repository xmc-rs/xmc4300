...
impl W {
    ...
    #[doc = "Bit 16 - Memory access attribute"]
    #[inline(always)]
    pub fn b(&mut self) -> B_W<'_, MPU_RASR_SPEC> {
        B_W::new(self, 16)
    }
    #[doc = "Bit 17 - Memory access attribute"]
    #[inline(always)]
    pub fn c(&mut self) -> C_W<'_, MPU_RASR_SPEC> {
        C_W::new(self, 17)
    }
    #[doc = "Bit 18 - Shareable bit"]
    #[inline(always)]
    pub fn s(&mut self) -> S_W<'_, MPU_RASR_SPEC> {
        S_W::new(self, 18)
    }
    #[doc = "Bits 19:21 - Memory access attribute"]
    #[inline(always)]
    pub fn tex(&mut self) -> TEX_W<'_, MPU_RASR_SPEC> {
        TEX_W::new(self, 19)
    }
    #[doc = "Bits 24:26 - Access permission field"]
    #[inline(always)]
    pub fn ap(&mut self) -> AP_W<'_, MPU_RASR_SPEC> {
        AP_W::new(self, 24)
    }
    #[doc = "Bit 28 - Instruction access disable bit"]
    #[inline(always)]
    pub fn xn(&mut self) -> XN_W<'_, MPU_RASR_SPEC> {
        XN_W::new(self, 28)
    }
}
