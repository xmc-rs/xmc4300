#[doc = "Reader of register NVIC_IPR17"]
pub type R = crate::R<u32, super::NVIC_IPR17>;
#[doc = "Writer for register NVIC_IPR17"]
pub type W = crate::W<u32, super::NVIC_IPR17>;
#[doc = "Register NVIC_IPR17 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR17 {
    type Type = u32;
    #[inline(always)]
