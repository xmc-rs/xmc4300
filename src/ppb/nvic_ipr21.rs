#[doc = "Reader of register NVIC_IPR21"]
pub type R = crate::R<u32, super::NVIC_IPR21>;
#[doc = "Writer for register NVIC_IPR21"]
pub type W = crate::W<u32, super::NVIC_IPR21>;
#[doc = "Register NVIC_IPR21 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR21 {
    type Type = u32;
    #[inline(always)]
