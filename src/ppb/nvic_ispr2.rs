...
pub struct R(crate::R<NVIC_ISPR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NVIC_ISPR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NVIC_ISPR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NVIC_ISPR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NVIC_ISPR2` writer"]
pub struct W(crate::W<NVIC_ISPR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NVIC_ISPR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NVIC_ISPR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NVIC_ISPR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SETPEND_W<'a, const O: u8> = crate::FieldWriter<'a, u32, NVIC_ISPR2_SPEC, u32, SETPEND_A, 32, O>;
