...
pub type R = crate::R<NvicIspr2Spec>;
#[doc = "Register `NVIC_ISPR2` writer"]
pub type W = crate::W<NvicIspr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn setpend(&mut self) -> SetpendW<NvicIspr2Spec> {
        SetpendW::new(self, 0)
    }
}
...
pub struct NvicIspr2Spec;
impl crate::RegisterSpec for NvicIspr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_ispr2::R`](R) reader structure"]
impl crate::Readable for NvicIspr2Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_ispr2::W`](W) writer structure"]
impl crate::Writable for NvicIspr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ISPR2 to value 0"]
impl crate::Resettable for NvicIspr2Spec {
