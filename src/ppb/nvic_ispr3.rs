#[doc = "Reader of register NVIC_ISPR3"]
pub type R = crate::R<u32, super::NVIC_ISPR3>;
#[doc = "Writer for register NVIC_ISPR3"]
pub type W = crate::W<u32, super::NVIC_ISPR3>;
#[doc = "Register NVIC_ISPR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_ISPR3 {
    type Type = u32;
    #[inline(always)]
