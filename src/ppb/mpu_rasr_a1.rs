...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> EnableW<MpuRasrA1Spec> {
        EnableW::new(self, 0)
    }
    #[doc = "Bits 1:5 - MPU protection region size"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SizeW<MpuRasrA1Spec> {
        SizeW::new(self, 1)
    }
    #[doc = "Bits 8:15 - Subregion disable bits"]
    #[inline(always)]
    #[must_use]
    pub fn srd(&mut self) -> SrdW<MpuRasrA1Spec> {
        SrdW::new(self, 8)
    }
    #[doc = "Bit 16 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn b(&mut self) -> BW<MpuRasrA1Spec> {
        BW::new(self, 16)
    }
    #[doc = "Bit 17 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn c(&mut self) -> CW<MpuRasrA1Spec> {
        CW::new(self, 17)
    }
    #[doc = "Bit 18 - Shareable bit"]
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> SW<MpuRasrA1Spec> {
        SW::new(self, 18)
    }
    #[doc = "Bits 19:21 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn tex(&mut self) -> TexW<MpuRasrA1Spec> {
        TexW::new(self, 19)
    }
    #[doc = "Bits 24:26 - Access permission field"]
    #[inline(always)]
    #[must_use]
    pub fn ap(&mut self) -> ApW<MpuRasrA1Spec> {
        ApW::new(self, 24)
    }
    #[doc = "Bit 28 - Instruction access disable bit"]
    #[inline(always)]
    #[must_use]
    pub fn xn(&mut self) -> XnW<MpuRasrA1Spec> {
        XnW::new(self, 28)
    }
}
