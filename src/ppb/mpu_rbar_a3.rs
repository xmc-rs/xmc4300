...
pub type R = crate::R<MpuRbarA3Spec>;
#[doc = "Register `MPU_RBAR_A3` writer"]
pub type W = crate::W<MpuRbarA3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region(&mut self) -> RegionW<MpuRbarA3Spec> {
        RegionW::new(self, 0)
    }
    #[doc = "Bit 4 - MPU Region Number valid bit"]
    #[inline(always)]
    #[must_use]
    pub fn valid(&mut self) -> ValidW<MpuRbarA3Spec> {
        ValidW::new(self, 4)
    }
    #[doc = "Bits 9:31 - Region base address field"]
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> AddrW<MpuRbarA3Spec> {
        AddrW::new(self, 9)
    }
}
...
pub struct MpuRbarA3Spec;
impl crate::RegisterSpec for MpuRbarA3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_rbar_a3::R`](R) reader structure"]
impl crate::Readable for MpuRbarA3Spec {}
#[doc = "`write(|w| ..)` method takes [`mpu_rbar_a3::W`](W) writer structure"]
impl crate::Writable for MpuRbarA3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPU_RBAR_A3 to value 0"]
impl crate::Resettable for MpuRbarA3Spec {
