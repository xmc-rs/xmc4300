...
pub type R = crate::R<NvicIpr13Spec>;
#[doc = "Register `NVIC_IPR13` writer"]
pub type W = crate::W<NvicIpr13Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pri_0(&mut self) -> Pri0W<NvicIpr13Spec> {
        Pri0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Priority value 1"]
    #[inline(always)]
    #[must_use]
    pub fn pri_1(&mut self) -> Pri1W<NvicIpr13Spec> {
        Pri1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Priority value 2"]
    #[inline(always)]
    #[must_use]
    pub fn pri_2(&mut self) -> Pri2W<NvicIpr13Spec> {
        Pri2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Priority value 3"]
    #[inline(always)]
    #[must_use]
    pub fn pri_3(&mut self) -> Pri3W<NvicIpr13Spec> {
        Pri3W::new(self, 24)
    }
}
...
pub struct NvicIpr13Spec;
impl crate::RegisterSpec for NvicIpr13Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_ipr13::R`](R) reader structure"]
impl crate::Readable for NvicIpr13Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_ipr13::W`](W) writer structure"]
impl crate::Writable for NvicIpr13Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_IPR13 to value 0"]
impl crate::Resettable for NvicIpr13Spec {
