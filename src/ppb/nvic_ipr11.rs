...
pub type R = crate::R<NvicIpr11Spec>;
#[doc = "Register `NVIC_IPR11` writer"]
pub type W = crate::W<NvicIpr11Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pri_0(&mut self) -> Pri0W<NvicIpr11Spec> {
        Pri0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Priority value 1"]
    #[inline(always)]
    #[must_use]
    pub fn pri_1(&mut self) -> Pri1W<NvicIpr11Spec> {
        Pri1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Priority value 2"]
    #[inline(always)]
    #[must_use]
    pub fn pri_2(&mut self) -> Pri2W<NvicIpr11Spec> {
        Pri2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Priority value 3"]
    #[inline(always)]
    #[must_use]
    pub fn pri_3(&mut self) -> Pri3W<NvicIpr11Spec> {
        Pri3W::new(self, 24)
    }
}
...
pub struct NvicIpr11Spec;
impl crate::RegisterSpec for NvicIpr11Spec {
    type Ux = u32;
}
...
impl crate::Resettable for NvicIpr11Spec {
