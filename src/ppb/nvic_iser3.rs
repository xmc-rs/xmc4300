...
pub type R = crate::R<NvicIser3Spec>;
#[doc = "Register `NVIC_ISER3` writer"]
pub type W = crate::W<NvicIser3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn setena(&mut self) -> SetenaW<NvicIser3Spec> {
        SetenaW::new(self, 0)
    }
}
