#[doc = "Reader of register NVIC_IPR20"]
pub type R = crate::R<u32, super::NVIC_IPR20>;
#[doc = "Writer for register NVIC_IPR20"]
pub type W = crate::W<u32, super::NVIC_IPR20>;
#[doc = "Register NVIC_IPR20 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR20 {
    type Type = u32;
    #[inline(always)]
