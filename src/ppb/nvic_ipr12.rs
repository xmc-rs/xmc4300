#[doc = "Reader of register NVIC_IPR12"]
pub type R = crate::R<u32, super::NVIC_IPR12>;
#[doc = "Writer for register NVIC_IPR12"]
pub type W = crate::W<u32, super::NVIC_IPR12>;
#[doc = "Register NVIC_IPR12 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR12 {
    type Type = u32;
    #[inline(always)]
