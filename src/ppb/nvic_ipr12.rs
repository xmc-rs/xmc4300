...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pri_0(&mut self) -> PRI_0_W<NVIC_IPR12_SPEC, 0> {
        PRI_0_W::new(self)
    }
    #[doc = "Bits 8:15 - Priority value 1"]
    #[inline(always)]
    #[must_use]
    pub fn pri_1(&mut self) -> PRI_1_W<NVIC_IPR12_SPEC, 8> {
        PRI_1_W::new(self)
    }
    #[doc = "Bits 16:23 - Priority value 2"]
    #[inline(always)]
    #[must_use]
    pub fn pri_2(&mut self) -> PRI_2_W<NVIC_IPR12_SPEC, 16> {
        PRI_2_W::new(self)
    }
    #[doc = "Bits 24:31 - Priority value 3"]
    #[inline(always)]
    #[must_use]
    pub fn pri_3(&mut self) -> PRI_3_W<NVIC_IPR12_SPEC, 24> {
        PRI_3_W::new(self)
    }
