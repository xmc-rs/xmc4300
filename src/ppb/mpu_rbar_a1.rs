...
pub type R = crate::R<MpuRbarA1Spec>;
#[doc = "Register `MPU_RBAR_A1` writer"]
pub type W = crate::W<MpuRbarA1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn region(&mut self) -> RegionW<MpuRbarA1Spec> {
        RegionW::new(self, 0)
    }
    #[doc = "Bit 4 - MPU Region Number valid bit"]
    #[inline(always)]
    #[must_use]
    pub fn valid(&mut self) -> ValidW<MpuRbarA1Spec> {
        ValidW::new(self, 4)
    }
    #[doc = "Bits 9:31 - Region base address field"]
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> AddrW<MpuRbarA1Spec> {
        AddrW::new(self, 9)
    }
}
...
pub struct MpuRbarA1Spec;
impl crate::RegisterSpec for MpuRbarA1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mpu_rbar_a1::R`](R) reader structure"]
impl crate::Readable for MpuRbarA1Spec {}
#[doc = "`write(|w| ..)` method takes [`mpu_rbar_a1::W`](W) writer structure"]
impl crate::Writable for MpuRbarA1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets MPU_RBAR_A1 to value 0"]
impl crate::Resettable for MpuRbarA1Spec {
