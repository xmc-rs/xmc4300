...
pub type REGION_W<'a, const O: u8> = crate::FieldWriter<'a, MPU_RBAR_A1_SPEC, 4, O>;
...
pub type VALID_W<'a, const O: u8> = crate::BitWriter<'a, MPU_RBAR_A1_SPEC, O, VALID_A>;
...
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, MPU_RBAR_A1_SPEC, 23, O, u32>;
impl R {
