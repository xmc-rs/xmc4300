...
pub type REGION_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MPU_RBAR_A1_SPEC, u8, u8, 4, O>;
...
pub type VALID_W<'a, const O: u8> = crate::BitWriter<'a, u32, MPU_RBAR_A1_SPEC, VALID_A, O>;
...
pub type ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MPU_RBAR_A1_SPEC, u32, u32, 23, O>;
impl R {
