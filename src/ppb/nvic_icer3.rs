#[doc = "Reader of register NVIC_ICER3"]
pub type R = crate::R<u32, super::NVIC_ICER3>;
#[doc = "Writer for register NVIC_ICER3"]
pub type W = crate::W<u32, super::NVIC_ICER3>;
#[doc = "Register NVIC_ICER3 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_ICER3 {
    type Type = u32;
    #[inline(always)]
