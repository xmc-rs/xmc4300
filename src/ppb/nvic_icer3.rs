...
pub type R = crate::R<NvicIcer3Spec>;
#[doc = "Register `NVIC_ICER3` writer"]
pub type W = crate::W<NvicIcer3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrena(&mut self) -> ClrenaW<NvicIcer3Spec> {
        ClrenaW::new(self, 0)
    }
}
...
pub struct NvicIcer3Spec;
impl crate::RegisterSpec for NvicIcer3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icer3::R`](R) reader structure"]
impl crate::Readable for NvicIcer3Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_icer3::W`](W) writer structure"]
impl crate::Writable for NvicIcer3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ICER3 to value 0"]
impl crate::Resettable for NvicIcer3Spec {
