#[doc = "Reader of register NVIC_ICPR2"]
pub type R = crate::R<u32, super::NVIC_ICPR2>;
#[doc = "Writer for register NVIC_ICPR2"]
pub type W = crate::W<u32, super::NVIC_ICPR2>;
#[doc = "Register NVIC_ICPR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_ICPR2 {
    type Type = u32;
    #[inline(always)]
