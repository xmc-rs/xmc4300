...
pub struct R(crate::R<NVIC_ICPR2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NVIC_ICPR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NVIC_ICPR2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NVIC_ICPR2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NVIC_ICPR2` writer"]
pub struct W(crate::W<NVIC_ICPR2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NVIC_ICPR2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NVIC_ICPR2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NVIC_ICPR2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CLRPEND_R(crate::FieldReader<u32, CLRPEND_A>);
impl CLRPEND_R {
...
impl core::ops::Deref for CLRPEND_R {
    type Target = crate::FieldReader<u32, CLRPEND_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
