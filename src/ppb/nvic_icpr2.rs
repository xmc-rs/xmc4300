...
pub type R = crate::R<NvicIcpr2Spec>;
#[doc = "Register `NVIC_ICPR2` writer"]
pub type W = crate::W<NvicIcpr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrpend(&mut self) -> ClrpendW<NvicIcpr2Spec> {
        ClrpendW::new(self, 0)
    }
}
...
pub struct NvicIcpr2Spec;
impl crate::RegisterSpec for NvicIcpr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icpr2::R`](R) reader structure"]
impl crate::Readable for NvicIcpr2Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_icpr2::W`](W) writer structure"]
impl crate::Writable for NvicIcpr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ICPR2 to value 0"]
impl crate::Resettable for NvicIcpr2Spec {
