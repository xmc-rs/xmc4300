...
pub type R = crate::R<NvicIcer0Spec>;
#[doc = "Register `NVIC_ICER0` writer"]
pub type W = crate::W<NvicIcer0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrena(&mut self) -> ClrenaW<NvicIcer0Spec> {
        ClrenaW::new(self, 0)
    }
}
...
pub struct NvicIcer0Spec;
impl crate::RegisterSpec for NvicIcer0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icer0::R`](R) reader structure"]
impl crate::Readable for NvicIcer0Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_icer0::W`](W) writer structure"]
impl crate::Writable for NvicIcer0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ICER0 to value 0"]
impl crate::Resettable for NvicIcer0Spec {
