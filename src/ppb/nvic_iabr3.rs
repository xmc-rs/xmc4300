#[doc = "Reader of register NVIC_IABR3"]
pub type R = crate::R<u32, super::NVIC_IABR3>;
#[doc = "Writer for register NVIC_IABR3"]
pub type W = crate::W<u32, super::NVIC_IABR3>;
#[doc = "Register NVIC_IABR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IABR3 {
    type Type = u32;
    #[inline(always)]
