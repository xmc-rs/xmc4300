#[doc = "Reader of register NVIC_ICPR3"]
pub type R = crate::R<u32, super::NVIC_ICPR3>;
#[doc = "Writer for register NVIC_ICPR3"]
pub type W = crate::W<u32, super::NVIC_ICPR3>;
#[doc = "Register NVIC_ICPR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_ICPR3 {
    type Type = u32;
    #[inline(always)]
