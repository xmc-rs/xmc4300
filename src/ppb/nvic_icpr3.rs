...
pub type R = crate::R<NvicIcpr3Spec>;
#[doc = "Register `NVIC_ICPR3` writer"]
pub type W = crate::W<NvicIcpr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrpend(&mut self) -> ClrpendW<NvicIcpr3Spec> {
        ClrpendW::new(self, 0)
    }
}
...
pub struct NvicIcpr3Spec;
impl crate::RegisterSpec for NvicIcpr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icpr3::R`](R) reader structure"]
impl crate::Readable for NvicIcpr3Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_icpr3::W`](W) writer structure"]
impl crate::Writable for NvicIcpr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ICPR3 to value 0"]
impl crate::Resettable for NvicIcpr3Spec {
