...
pub type MEMFAULTACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type BUSFAULTACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type USGFAULTACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type SVCALLACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type MONITORACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type PENDSVACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type SYSTICKACT_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type USGFAULTPENDED_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type MEMFAULTPENDED_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type BUSFAULTPENDED_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type MEMFAULTENA_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type BUSFAULTENA_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
...
pub type USGFAULTENA_W<'a, const O: u8> = crate::BitWriter<'a, SHCSR_SPEC, O>;
impl R {
