...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<MPU_RASR_A3_SPEC, 0> {
        ENABLE_W::new(self)
    }
    #[doc = "Bits 1:5 - MPU protection region size"]
    #[inline(always)]
    #[must_use]
    pub fn size(&mut self) -> SIZE_W<MPU_RASR_A3_SPEC, 1> {
        SIZE_W::new(self)
    }
    #[doc = "Bits 8:15 - Subregion disable bits"]
    #[inline(always)]
    #[must_use]
    pub fn srd(&mut self) -> SRD_W<MPU_RASR_A3_SPEC, 8> {
        SRD_W::new(self)
    }
    #[doc = "Bit 16 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn b(&mut self) -> B_W<MPU_RASR_A3_SPEC, 16> {
        B_W::new(self)
    }
    #[doc = "Bit 17 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn c(&mut self) -> C_W<MPU_RASR_A3_SPEC, 17> {
        C_W::new(self)
    }
    #[doc = "Bit 18 - Shareable bit"]
    #[inline(always)]
    #[must_use]
    pub fn s(&mut self) -> S_W<MPU_RASR_A3_SPEC, 18> {
        S_W::new(self)
    }
    #[doc = "Bits 19:21 - Memory access attribute"]
    #[inline(always)]
    #[must_use]
    pub fn tex(&mut self) -> TEX_W<MPU_RASR_A3_SPEC, 19> {
        TEX_W::new(self)
    }
    #[doc = "Bits 24:26 - Access permission field"]
    #[inline(always)]
    #[must_use]
    pub fn ap(&mut self) -> AP_W<MPU_RASR_A3_SPEC, 24> {
        AP_W::new(self)
    }
    #[doc = "Bit 28 - Instruction access disable bit"]
    #[inline(always)]
    #[must_use]
    pub fn xn(&mut self) -> XN_W<MPU_RASR_A3_SPEC, 28> {
        XN_W::new(self)
    }
