#[doc = "Reader of register NVIC_IPR19"]
pub type R = crate::R<u32, super::NVIC_IPR19>;
#[doc = "Writer for register NVIC_IPR19"]
pub type W = crate::W<u32, super::NVIC_IPR19>;
#[doc = "Register NVIC_IPR19 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR19 {
    type Type = u32;
    #[inline(always)]
