#[doc = "Reader of register NVIC_IPR16"]
pub type R = crate::R<u32, super::NVIC_IPR16>;
#[doc = "Writer for register NVIC_IPR16"]
pub type W = crate::W<u32, super::NVIC_IPR16>;
#[doc = "Register NVIC_IPR16 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR16 {
    type Type = u32;
    #[inline(always)]
