#[doc = "Reader of register NVIC_IPR22"]
pub type R = crate::R<u32, super::NVIC_IPR22>;
#[doc = "Writer for register NVIC_IPR22"]
pub type W = crate::W<u32, super::NVIC_IPR22>;
#[doc = "Register NVIC_IPR22 `reset()`'s with value 0"]
impl crate::ResetValue for super::NVIC_IPR22 {
    type Type = u32;
    #[inline(always)]
