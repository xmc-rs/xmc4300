...
pub struct R(crate::R<NVIC_IPR22_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NVIC_IPR22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NVIC_IPR22_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NVIC_IPR22_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NVIC_IPR22` writer"]
pub struct W(crate::W<NVIC_IPR22_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NVIC_IPR22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NVIC_IPR22_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NVIC_IPR22_SPEC>) -> Self {
        W(writer)
    }
}
