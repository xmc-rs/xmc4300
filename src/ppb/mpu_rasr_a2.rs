...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, MPU_RASR_A2_SPEC, O>;
...
pub type SIZE_W<'a, const O: u8> = crate::FieldWriter<'a, MPU_RASR_A2_SPEC, 5, O>;
...
pub type SRD_W<'a, const O: u8> = crate::FieldWriter<'a, MPU_RASR_A2_SPEC, 8, O, SRD_A>;
...
pub type XN_W<'a, const O: u8> = crate::BitWriter<'a, MPU_RASR_A2_SPEC, O, XN_A>;
