...
pub type R = crate::R<NvicIcer2Spec>;
#[doc = "Register `NVIC_ICER2` writer"]
pub type W = crate::W<NvicIcer2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clrena(&mut self) -> ClrenaW<NvicIcer2Spec> {
        ClrenaW::new(self, 0)
    }
}
...
pub struct NvicIcer2Spec;
impl crate::RegisterSpec for NvicIcer2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`nvic_icer2::R`](R) reader structure"]
impl crate::Readable for NvicIcer2Spec {}
#[doc = "`write(|w| ..)` method takes [`nvic_icer2::W`](W) writer structure"]
impl crate::Writable for NvicIcer2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets NVIC_ICER2 to value 0"]
impl crate::Resettable for NvicIcer2Spec {
