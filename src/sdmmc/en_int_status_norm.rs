...
pub type CMD_COMPLETE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, CMD_COMPLETE_EN_A, O>;
...
pub type TX_COMPLETE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, TX_COMPLETE_EN_A, O>;
...
pub type BLOCK_GAP_EVENT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, BLOCK_GAP_EVENT_EN_A, O>;
...
pub type BUFF_WRITE_READY_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, BUFF_WRITE_READY_EN_A, O>;
...
pub type BUFF_READ_READY_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, BUFF_READ_READY_EN_A, O>;
...
pub type CARD_INS_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, CARD_INS_EN_A, O>;
...
pub type CARD_REMOVAL_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, CARD_REMOVAL_EN_A, O>;
...
pub type CARD_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_STATUS_NORM_SPEC, CARD_INT_EN_A, O>;
