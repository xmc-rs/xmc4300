...
pub type R = crate::R<EnIntStatusNormSpec>;
#[doc = "Register `EN_INT_STATUS_NORM` writer"]
pub type W = crate::W<EnIntStatusNormSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_complete_en(&mut self) -> CmdCompleteEnW<EnIntStatusNormSpec> {
        CmdCompleteEnW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer Complete Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tx_complete_en(&mut self) -> TxCompleteEnW<EnIntStatusNormSpec> {
        TxCompleteEnW::new(self, 1)
    }
    #[doc = "Bit 2 - Block Gap Event Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn block_gap_event_en(&mut self) -> BlockGapEventEnW<EnIntStatusNormSpec> {
        BlockGapEventEnW::new(self, 2)
    }
    #[doc = "Bit 4 - Buffer Write Ready Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buff_write_ready_en(&mut self) -> BuffWriteReadyEnW<EnIntStatusNormSpec> {
        BuffWriteReadyEnW::new(self, 4)
    }
    #[doc = "Bit 5 - Buffer Read Ready Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buff_read_ready_en(&mut self) -> BuffReadReadyEnW<EnIntStatusNormSpec> {
        BuffReadReadyEnW::new(self, 5)
    }
    #[doc = "Bit 6 - Card Insertion Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_ins_en(&mut self) -> CardInsEnW<EnIntStatusNormSpec> {
        CardInsEnW::new(self, 6)
    }
    #[doc = "Bit 7 - Card Removal Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_removal_en(&mut self) -> CardRemovalEnW<EnIntStatusNormSpec> {
        CardRemovalEnW::new(self, 7)
    }
    #[doc = "Bit 8 - Card Interrupt Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_int_en(&mut self) -> CardIntEnW<EnIntStatusNormSpec> {
...
pub struct EnIntStatusNormSpec;
impl crate::RegisterSpec for EnIntStatusNormSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`en_int_status_norm::R`](R) reader structure"]
impl crate::Readable for EnIntStatusNormSpec {}
#[doc = "`write(|w| ..)` method takes [`en_int_status_norm::W`](W) writer structure"]
impl crate::Writable for EnIntStatusNormSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u16 = 0;
}
#[doc = "`reset()` method sets EN_INT_STATUS_NORM to value 0"]
impl crate::Resettable for EnIntStatusNormSpec {
