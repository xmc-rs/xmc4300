...
pub struct R(crate::R<EN_INT_STATUS_ERR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EN_INT_STATUS_ERR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EN_INT_STATUS_ERR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EN_INT_STATUS_ERR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EN_INT_STATUS_ERR` writer"]
pub struct W(crate::W<EN_INT_STATUS_ERR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EN_INT_STATUS_ERR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EN_INT_STATUS_ERR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EN_INT_STATUS_ERR_SPEC>) -> Self {
        W(writer)
    }
}
