...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_timeout_err_en(&mut self) -> CMD_TIMEOUT_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 0> {
        CMD_TIMEOUT_ERR_EN_W::new(self)
    }
    #[doc = "Bit 1 - Command CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_crc_err_en(&mut self) -> CMD_CRC_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 1> {
        CMD_CRC_ERR_EN_W::new(self)
    }
    #[doc = "Bit 2 - Command End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_end_bit_err_en(&mut self) -> CMD_END_BIT_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 2> {
        CMD_END_BIT_ERR_EN_W::new(self)
    }
    #[doc = "Bit 3 - Command Index Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmd_ind_err_en(&mut self) -> CMD_IND_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 3> {
        CMD_IND_ERR_EN_W::new(self)
    }
    #[doc = "Bit 4 - Data Timeout Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn data_timeout_err_en(&mut self) -> DATA_TIMEOUT_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 4> {
        DATA_TIMEOUT_ERR_EN_W::new(self)
    }
    #[doc = "Bit 5 - Data CRC Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn data_crc_err_en(&mut self) -> DATA_CRC_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 5> {
        DATA_CRC_ERR_EN_W::new(self)
    }
    #[doc = "Bit 6 - Data End Bit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn data_end_bit_err_en(&mut self) -> DATA_END_BIT_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 6> {
        DATA_END_BIT_ERR_EN_W::new(self)
    }
    #[doc = "Bit 7 - Current Limit Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn current_limit_err_en(&mut self) -> CURRENT_LIMIT_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 7> {
        CURRENT_LIMIT_ERR_EN_W::new(self)
    }
    #[doc = "Bit 8 - Auto CMD12 Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn acmd_err_en(&mut self) -> ACMD_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 8> {
        ACMD_ERR_EN_W::new(self)
    }
    #[doc = "Bit 12 - Target Response Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn target_resp_err_en(&mut self) -> TARGET_RESP_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 12> {
        TARGET_RESP_ERR_EN_W::new(self)
    }
    #[doc = "Bit 13 - Ceata Error Status Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ceata_err_en(&mut self) -> CEATA_ERR_EN_W<EN_INT_STATUS_ERR_SPEC, 13> {
