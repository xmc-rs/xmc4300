...
pub type CMD_TIMEOUT_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CMD_TIMEOUT_ERR_EN_A, O>;
...
pub type CMD_CRC_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CMD_CRC_ERR_EN_A, O>;
...
pub type CMD_END_BIT_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CMD_END_BIT_ERR_EN_A, O>;
...
pub type CMD_IND_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CMD_IND_ERR_EN_A, O>;
...
pub type DATA_TIMEOUT_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, DATA_TIMEOUT_ERR_EN_A, O>;
...
pub type DATA_CRC_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, DATA_CRC_ERR_EN_A, O>;
...
pub type DATA_END_BIT_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, DATA_END_BIT_ERR_EN_A, O>;
...
pub type CURRENT_LIMIT_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CURRENT_LIMIT_ERR_EN_A, O>;
...
pub type ACMD_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, ACMD_ERR_EN_A, O>;
...
pub type TARGET_RESP_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, TARGET_RESP_ERR_EN_A, O>;
...
pub type CEATA_ERR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u16, EN_INT_SIGNAL_ERR_SPEC, CEATA_ERR_EN_A, O>;
