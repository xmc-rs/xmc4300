...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_complete_en(&mut self) -> CMD_COMPLETE_EN_W<EN_INT_SIGNAL_NORM_SPEC, 0> {
        CMD_COMPLETE_EN_W::new(self)
    }
    #[doc = "Bit 1 - Transfer Complete Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn tx_complete_en(&mut self) -> TX_COMPLETE_EN_W<EN_INT_SIGNAL_NORM_SPEC, 1> {
        TX_COMPLETE_EN_W::new(self)
    }
    #[doc = "Bit 2 - Block Gap Event Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn block_gap_event_en(&mut self) -> BLOCK_GAP_EVENT_EN_W<EN_INT_SIGNAL_NORM_SPEC, 2> {
        BLOCK_GAP_EVENT_EN_W::new(self)
    }
    #[doc = "Bit 4 - Buffer Write Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buff_write_ready_en(&mut self) -> BUFF_WRITE_READY_EN_W<EN_INT_SIGNAL_NORM_SPEC, 4> {
        BUFF_WRITE_READY_EN_W::new(self)
    }
    #[doc = "Bit 5 - Buffer Read Ready Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn buff_read_ready_en(&mut self) -> BUFF_READ_READY_EN_W<EN_INT_SIGNAL_NORM_SPEC, 5> {
        BUFF_READ_READY_EN_W::new(self)
    }
    #[doc = "Bit 6 - Card Insertion Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_ins_en(&mut self) -> CARD_INS_EN_W<EN_INT_SIGNAL_NORM_SPEC, 6> {
        CARD_INS_EN_W::new(self)
    }
    #[doc = "Bit 7 - Card Removal Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_removal_en(&mut self) -> CARD_REMOVAL_EN_W<EN_INT_SIGNAL_NORM_SPEC, 7> {
        CARD_REMOVAL_EN_W::new(self)
    }
    #[doc = "Bit 8 - Card Interrupt Signal Enable"]
    #[inline(always)]
    #[must_use]
    pub fn card_int_en(&mut self) -> CARD_INT_EN_W<EN_INT_SIGNAL_NORM_SPEC, 8> {
