...
#[doc = "SM_P_START_ADR (r) register accessor: Physical Start Address SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_p_start_adr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_p_start_adr`] module"]
...
#[doc = "SM_LEN (r) register accessor: Length SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_len::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_len`] module"]
pub type SM_LEN = crate::Reg<sm_len::SM_LEN_SPEC>;
#[doc = "Length SyncManager 0"]
pub mod sm_len;
#[doc = "SM_CONTROL (r) register accessor: Control Register SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_control::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_control`] module"]
pub type SM_CONTROL = crate::Reg<sm_control::SM_CONTROL_SPEC>;
#[doc = "Control Register SyncManager 0"]
pub mod sm_control;
#[doc = "SM_STATUS (r) register accessor: Status Register SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_status::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_status`] module"]
pub type SM_STATUS = crate::Reg<sm_status::SM_STATUS_SPEC>;
#[doc = "Status Register SyncManager 0"]
pub mod sm_status;
#[doc = "SM_ACT (r) register accessor: Activate SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_act::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_act`] module"]
pub type SM_ACT = crate::Reg<sm_act::SM_ACT_SPEC>;
#[doc = "Activate SyncManager 0"]
pub mod sm_act;
#[doc = "SM_PDI_CTR (rw) register accessor: PDI Control SyncManager 0\n\nYou can [`read`](crate::Reg::read) this register and get [`sm_pdi_ctr::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sm_pdi_ctr::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sm_pdi_ctr`] module"]
