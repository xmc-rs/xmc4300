...
pub type R = crate::R<DcCycStartTimeSpec>;
#[doc = "Register `DC_CYC_START_TIME[%s]` writer"]
pub type W = crate::W<DcCycStartTimeSpec>;
#[doc = "Field `DC_CYC_START_TIME` reader - Start Time Cyclic Operation"]
pub type DcCycStartTimeR = crate::FieldReader<u32>;
#[doc = "Field `DC_CYC_START_TIME` writer - Start Time Cyclic Operation"]
pub type DcCycStartTimeW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Start Time Cyclic Operation"]
    #[inline(always)]
    pub fn dc_cyc_start_time(&self) -> DcCycStartTimeR {
        DcCycStartTimeR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Start Time Cyclic Operation"]
    #[inline(always)]
    #[must_use]
    pub fn dc_cyc_start_time(&mut self) -> DcCycStartTimeW<DcCycStartTimeSpec> {
        DcCycStartTimeW::new(self, 0)
    }
}
...
pub struct DcCycStartTimeSpec;
impl crate::RegisterSpec for DcCycStartTimeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dc_cyc_start_time::R`](R) reader structure"]
impl crate::Readable for DcCycStartTimeSpec {}
#[doc = "`write(|w| ..)` method takes [`dc_cyc_start_time::W`](W) writer structure"]
impl crate::Writable for DcCycStartTimeSpec {
...
to value 0"]
impl crate::Resettable for DcCycStartTimeSpec {
