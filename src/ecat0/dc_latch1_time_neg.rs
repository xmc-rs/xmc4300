...
pub struct R(crate::R<DC_LATCH1_TIME_NEG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DC_LATCH1_TIME_NEG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DC_LATCH1_TIME_NEG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DC_LATCH1_TIME_NEG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `DC_LATCH1_TIME_NEG` reader - Captures System time at the negative edge of the Latch1 signal"]
pub struct DC_LATCH1_TIME_NEG_R(crate::FieldReader<u32, u32>);
impl DC_LATCH1_TIME_NEG_R {
    pub(crate) fn new(bits: u32) -> Self {
        DC_LATCH1_TIME_NEG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DC_LATCH1_TIME_NEG_R {
