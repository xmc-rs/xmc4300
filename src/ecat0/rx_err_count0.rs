...
pub type R = crate::R<RX_ERR_COUNT0_SPEC>;
...
#[doc = "RX Error Counter Port 0\n\nYou can [`read`](crate::Reg::read) this register and get [`rx_err_count0::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
