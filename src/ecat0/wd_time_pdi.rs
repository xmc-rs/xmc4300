...
impl W {
    #[doc = "Bits 0:15 - Watchdog Time PDI"]
    #[inline(always)]
    pub fn wd_time_pdi(&mut self) -> WD_TIME_PDI_W<'_, WD_TIME_PDI_SPEC> {
        WD_TIME_PDI_W::new(self, 0)
    }
}
#[doc = "Watchdog Time PDI\n\nYou can [`read`](crate::Reg::read) this register and get [`wd_time_pdi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wd_time_pdi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
