...
pub type R = crate::R<EepDataSpec>;
#[doc = "Register `EEP_DATA[%s]` writer"]
pub type W = crate::W<EepDataSpec>;
#[doc = "Field `EEP_DATA` reader - EEPROM Data"]
pub type EepDataR = crate::FieldReader<u32>;
#[doc = "Field `EEP_DATA` writer - EEPROM Data"]
pub type EepDataW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - EEPROM Data"]
    #[inline(always)]
    pub fn eep_data(&self) -> EepDataR {
        EepDataR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - EEPROM Data"]
    #[inline(always)]
    #[must_use]
    pub fn eep_data(&mut self) -> EepDataW<EepDataSpec> {
        EepDataW::new(self, 0)
    }
}
...
to value 0"]
impl crate::Resettable for EepDataSpec {
