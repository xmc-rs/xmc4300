...
#[doc = "Register captures System time at the negative edge of the Latch0 signal\n\nYou can [`read`](crate::Reg::read) this register and get [`dc_latch0_time_neg::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
#[doc = "`reset()` method sets DC_LATCH0_TIME_NEG[%s] to value 0"]
