...
pub type L1_POS_W<'a, const O: u8> = crate::BitWriter<'a, DC_LATCH1_CONT_SPEC, O, L1_POS_A>;
...
pub type L1_NEG_W<'a, const O: u8> = crate::BitWriter<'a, DC_LATCH1_CONT_SPEC, O, L1_NEG_A>;
