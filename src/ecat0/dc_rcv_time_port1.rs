...
pub struct LOCAL_TIME_P1_R(crate::FieldReader<u32, u32>);
impl LOCAL_TIME_P1_R {
    pub(crate) fn new(bits: u32) -> Self {
        LOCAL_TIME_P1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LOCAL_TIME_P1_R {
