...
pub type RS0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS5_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS6_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type RS7_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rs0(&mut self) -> RS0_W<SRSEL0_SPEC, 0> {
        RS0_W::new(self)
    }
    #[doc = "Bits 4:7 - Request Source for Line 1"]
    #[inline(always)]
    #[must_use]
    pub fn rs1(&mut self) -> RS1_W<SRSEL0_SPEC, 4> {
        RS1_W::new(self)
    }
    #[doc = "Bits 8:11 - Request Source for Line 2"]
    #[inline(always)]
    #[must_use]
    pub fn rs2(&mut self) -> RS2_W<SRSEL0_SPEC, 8> {
        RS2_W::new(self)
    }
    #[doc = "Bits 12:15 - Request Source for Line 3"]
    #[inline(always)]
    #[must_use]
    pub fn rs3(&mut self) -> RS3_W<SRSEL0_SPEC, 12> {
        RS3_W::new(self)
    }
    #[doc = "Bits 16:19 - Request Source for Line 4"]
    #[inline(always)]
    #[must_use]
    pub fn rs4(&mut self) -> RS4_W<SRSEL0_SPEC, 16> {
        RS4_W::new(self)
    }
    #[doc = "Bits 20:23 - Request Source for Line 5"]
    #[inline(always)]
    #[must_use]
    pub fn rs5(&mut self) -> RS5_W<SRSEL0_SPEC, 20> {
        RS5_W::new(self)
    }
    #[doc = "Bits 24:27 - Request Source for Line 6"]
    #[inline(always)]
    #[must_use]
    pub fn rs6(&mut self) -> RS6_W<SRSEL0_SPEC, 24> {
        RS6_W::new(self)
    }
    #[doc = "Bits 28:31 - Request Source for Line 7"]
    #[inline(always)]
    #[must_use]
    pub fn rs7(&mut self) -> RS7_W<SRSEL0_SPEC, 28> {
        RS7_W::new(self)
    }
