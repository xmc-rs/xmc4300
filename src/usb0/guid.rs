...
pub type MOD_REV_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
#[doc = "Field `MOD_TYPE` reader - Module Type"]
pub type MOD_TYPE_R = crate::FieldReader;
#[doc = "Field `MOD_TYPE` writer - Module Type"]
pub type MOD_TYPE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
...
pub type MOD_NUMBER_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mod_rev(&mut self) -> MOD_REV_W<GUID_SPEC, 0> {
        MOD_REV_W::new(self)
    }
    #[doc = "Bits 8:15 - Module Type"]
    #[inline(always)]
    #[must_use]
    pub fn mod_type(&mut self) -> MOD_TYPE_W<GUID_SPEC, 8> {
        MOD_TYPE_W::new(self)
    }
    #[doc = "Bits 16:31 - Module Number"]
    #[inline(always)]
    #[must_use]
    pub fn mod_number(&mut self) -> MOD_NUMBER_W<GUID_SPEC, 16> {
