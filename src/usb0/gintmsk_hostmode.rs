...
pub type MODE_MIS_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type OTGINT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
#[doc = "Field `SofMsk` reader - Start of Frame Mask"]
pub type SOF_MSK_R = crate::BitReader;
#[doc = "Field `SofMsk` writer - Start of Frame Mask"]
pub type SOF_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type RX_FLVL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type INCOMPL_PMSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type PRT_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type HCH_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type PTX_FEMP_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type CON_IDSTS_CHNG_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type DISCONN_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type SESS_REQ_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
...
pub type WK_UP_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_HOSTMODE_SPEC, O>;
impl R {
