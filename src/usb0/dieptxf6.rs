...
pub type INEPN_TX_FST_ADDR_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPTXF6_SPEC, 16, O, u16>;
...
pub type INEPN_TX_FDEP_W<'a, const O: u8> = crate::FieldWriter<'a, DIEPTXF6_SPEC, 16, O, u16>;
impl R {
