...
pub type XFER_COMPL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type EPDISBLD_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
#[doc = "Field `AHBErrMsk` reader - AHB Error Mask"]
pub type AHBERR_MSK_R = crate::BitReader;
#[doc = "Field `AHBErrMsk` writer - AHB Error Mask"]
pub type AHBERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type TIME_OUTMSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type INTKN_TXFEMP_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type INEPNAK_EFF_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type TXFIFO_UNDRN_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
...
pub type BNAIN_INTR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
#[doc = "Field `NAKMsk` reader - NAK interrupt Mask"]
pub type NAKMSK_R = crate::BitReader;
#[doc = "Field `NAKMsk` writer - NAK interrupt Mask"]
pub type NAKMSK_W<'a, const O: u8> = crate::BitWriter<'a, DIEPMSK_SPEC, O>;
impl R {
