...
pub type XFER_COMPL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type EPDISBLD_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
#[doc = "Field `AHBErrMsk` reader - AHB Error"]
pub type AHBERR_MSK_R = crate::BitReader;
#[doc = "Field `AHBErrMsk` writer - AHB Error"]
pub type AHBERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type SET_UPMSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type OUTTKN_EPDIS_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type BACK2BACK_SETUP_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type OUT_PKT_ERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type BNA_OUT_INTR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
...
pub type BBLE_ERR_MSK_W<'a, const O: u8> = crate::BitWriter<'a, DOEPMSK_SPEC, O>;
