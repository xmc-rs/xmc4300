...
pub type MODE_MIS_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
#[doc = "Field `OTGInt` reader - OTG Interrupt"]
pub type OTGINT_R = crate::BitReader;
#[doc = "Field `Sof` reader - Start of Frame"]
pub type SOF_R = crate::BitReader;
#[doc = "Field `Sof` writer - Start of Frame"]
pub type SOF_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
...
pub type INCOMPL_P_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
...
pub type CON_IDSTS_CHNG_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
...
pub type DISCONN_INT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
...
pub type SESS_REQ_INT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
...
pub type WK_UP_INT_W<'a, const O: u8> = crate::BitWriter<'a, GINTSTS_HOSTMODE_SPEC, O>;
impl R {
