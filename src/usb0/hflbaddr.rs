...
pub type STARTING_ADDRESS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn starting_address(&mut self) -> STARTING_ADDRESS_W<HFLBADDR_SPEC, 0> {
        STARTING_ADDRESS_W::new(self)
    }
