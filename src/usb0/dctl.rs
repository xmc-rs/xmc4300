...
impl W {
    #[doc = "Bit 0 - Remote Wakeup Signaling"]
    #[inline(always)]
    pub fn rmt_wk_up_sig(&mut self) -> RMT_WK_UP_SIG_W<'_, DCTL_SPEC> {
        RMT_WK_UP_SIG_W::new(self, 0)
    }
    #[doc = "Bit 1 - Soft Disconnect"]
    #[inline(always)]
    pub fn sft_discon(&mut self) -> SFT_DISCON_W<'_, DCTL_SPEC> {
        SFT_DISCON_W::new(self, 1)
    }
    #[doc = "Bit 7 - Set Global Non-periodic IN NAK"]
    #[inline(always)]
    pub fn sgnpin_nak(&mut self) -> SGNPIN_NAK_W<'_, DCTL_SPEC> {
        SGNPIN_NAK_W::new(self, 7)
    }
    #[doc = "Bit 8 - Clear Global Non-periodic IN NAK"]
    #[inline(always)]
    pub fn cgnpin_nak(&mut self) -> CGNPIN_NAK_W<'_, DCTL_SPEC> {
    ...
    #[doc = "Bit 15 - Ignore frame number for isochronous endpoints in case of Scatter/Gather DMA"]
    #[inline(always)]
    pub fn ignr_frm_num(&mut self) -> IGNR_FRM_NUM_W<'_, DCTL_SPEC> {
        IGNR_FRM_NUM_W::new(self, 15)
    }
    #[doc = "Bit 16 - Set NAK automatically on babble"]
    #[inline(always)]
    pub fn nak_on_bble(&mut self) -> NAK_ON_BBLE_W<'_, DCTL_SPEC> {
        NAK_ON_BBLE_W::new(self, 16)
    }
    #[doc = "Bit 17 - Enable continue on BNA"]
    #[inline(always)]
    pub fn en_cont_on_bna(&mut self) -> EN_CONT_ON_BNA_W<'_, DCTL_SPEC> {
