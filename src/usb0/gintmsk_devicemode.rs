...
pub type GINNAK_EFF_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type GOUTNAK_EFF_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERLY_SUSP_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type USBSUSP_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `USBRstMsk` reader - USB Reset Mask"]
pub type USBRST_MSK_R = crate::BitReader;
#[doc = "Field `USBRstMsk` writer - USB Reset Mask"]
pub type USBRST_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ENUM_DONE_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ISOOUT_DROP_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type IEPINT_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OEPINT_MSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INCOMP_ISOINMSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type INCOMPL_SOOUTMSK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mode_mis_msk(&mut self) -> MODE_MIS_MSK_W<GINTMSK_DEVICEMODE_SPEC, 1> {
        MODE_MIS_MSK_W::new(self)
    }
    #[doc = "Bit 2 - OTG Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn otgint_msk(&mut self) -> OTGINT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 2> {
        OTGINT_MSK_W::new(self)
    }
    #[doc = "Bit 3 - Start of Frame Mask"]
    #[inline(always)]
    #[must_use]
    pub fn sof_msk(&mut self) -> SOF_MSK_W<GINTMSK_DEVICEMODE_SPEC, 3> {
        SOF_MSK_W::new(self)
    }
    #[doc = "Bit 4 - Receive FIFO Non-Empty Mask"]
    #[inline(always)]
    #[must_use]
    pub fn rx_flvl_msk(&mut self) -> RX_FLVL_MSK_W<GINTMSK_DEVICEMODE_SPEC, 4> {
        RX_FLVL_MSK_W::new(self)
    }
    #[doc = "Bit 6 - Global Non-periodic IN NAK Effective Mask"]
    #[inline(always)]
    #[must_use]
    pub fn ginnak_eff_msk(&mut self) -> GINNAK_EFF_MSK_W<GINTMSK_DEVICEMODE_SPEC, 6> {
        GINNAK_EFF_MSK_W::new(self)
    }
    #[doc = "Bit 7 - Global OUT NAK Effective Mask"]
    #[inline(always)]
    #[must_use]
    pub fn goutnak_eff_msk(&mut self) -> GOUTNAK_EFF_MSK_W<GINTMSK_DEVICEMODE_SPEC, 7> {
        GOUTNAK_EFF_MSK_W::new(self)
    }
    #[doc = "Bit 10 - Early Suspend Mask"]
    #[inline(always)]
    #[must_use]
    pub fn erly_susp_msk(&mut self) -> ERLY_SUSP_MSK_W<GINTMSK_DEVICEMODE_SPEC, 10> {
        ERLY_SUSP_MSK_W::new(self)
    }
    #[doc = "Bit 11 - USB Suspend Mask"]
    #[inline(always)]
    #[must_use]
    pub fn usbsusp_msk(&mut self) -> USBSUSP_MSK_W<GINTMSK_DEVICEMODE_SPEC, 11> {
        USBSUSP_MSK_W::new(self)
    }
    #[doc = "Bit 12 - USB Reset Mask"]
    #[inline(always)]
    #[must_use]
    pub fn usbrst_msk(&mut self) -> USBRST_MSK_W<GINTMSK_DEVICEMODE_SPEC, 12> {
        USBRST_MSK_W::new(self)
    }
    #[doc = "Bit 13 - Enumeration Done Mask"]
    #[inline(always)]
    #[must_use]
    pub fn enum_done_msk(&mut self) -> ENUM_DONE_MSK_W<GINTMSK_DEVICEMODE_SPEC, 13> {
        ENUM_DONE_MSK_W::new(self)
    }
    #[doc = "Bit 14 - Isochronous OUT Packet Dropped Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn isoout_drop_msk(&mut self) -> ISOOUT_DROP_MSK_W<GINTMSK_DEVICEMODE_SPEC, 14> {
        ISOOUT_DROP_MSK_W::new(self)
    }
    #[doc = "Bit 15 - End of Periodic Frame Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn eopfmsk(&mut self) -> EOPFMSK_W<GINTMSK_DEVICEMODE_SPEC, 15> {
        EOPFMSK_W::new(self)
    }
    #[doc = "Bit 18 - IN Endpoints Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn iepint_msk(&mut self) -> IEPINT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 18> {
        IEPINT_MSK_W::new(self)
    }
    #[doc = "Bit 19 - OUT Endpoints Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn oepint_msk(&mut self) -> OEPINT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 19> {
        OEPINT_MSK_W::new(self)
    }
    #[doc = "Bit 20 - Incomplete Isochronous IN Transfer Mask"]
    #[inline(always)]
    #[must_use]
    pub fn incomp_isoinmsk(&mut self) -> INCOMP_ISOINMSK_W<GINTMSK_DEVICEMODE_SPEC, 20> {
        INCOMP_ISOINMSK_W::new(self)
    }
    #[doc = "Bit 21 - Incomplete Isochronous OUT Transfer Mask"]
    #[inline(always)]
    #[must_use]
    pub fn incompl_sooutmsk(&mut self) -> INCOMPL_SOOUTMSK_W<GINTMSK_DEVICEMODE_SPEC, 21> {
        INCOMPL_SOOUTMSK_W::new(self)
    }
    #[doc = "Bit 28 - Connector ID Status Change Mask"]
    #[inline(always)]
    #[must_use]
    pub fn con_idsts_chng_msk(&mut self) -> CON_IDSTS_CHNG_MSK_W<GINTMSK_DEVICEMODE_SPEC, 28> {
        CON_IDSTS_CHNG_MSK_W::new(self)
    }
    #[doc = "Bit 29 - Disconnect Detected Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn disconn_int_msk(&mut self) -> DISCONN_INT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 29> {
        DISCONN_INT_MSK_W::new(self)
    }
    #[doc = "Bit 30 - Session Request/New Session Detected Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn sess_req_int_msk(&mut self) -> SESS_REQ_INT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 30> {
        SESS_REQ_INT_MSK_W::new(self)
    }
    #[doc = "Bit 31 - Resume/Remote Wakeup Detected Interrupt Mask"]
    #[inline(always)]
    #[must_use]
    pub fn wk_up_int_msk(&mut self) -> WK_UP_INT_MSK_W<GINTMSK_DEVICEMODE_SPEC, 31> {
