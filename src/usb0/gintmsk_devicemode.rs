...
pub type MODE_MIS_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type OTGINT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
#[doc = "Field `SofMsk` reader - Start of Frame Mask"]
pub type SOF_MSK_R = crate::BitReader;
#[doc = "Field `SofMsk` writer - Start of Frame Mask"]
pub type SOF_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type RX_FLVL_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type GINNAK_EFF_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type GOUTNAK_EFF_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type ERLY_SUSP_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type USBSUSP_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
#[doc = "Field `USBRstMsk` reader - USB Reset Mask"]
pub type USBRST_MSK_R = crate::BitReader;
#[doc = "Field `USBRstMsk` writer - USB Reset Mask"]
pub type USBRST_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type ENUM_DONE_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type ISOOUT_DROP_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type EOPFMSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type IEPINT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type OEPINT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type INCOMP_ISOINMSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type INCOMPL_SOOUTMSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type CON_IDSTS_CHNG_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type DISCONN_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type SESS_REQ_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
...
pub type WK_UP_INT_MSK_W<'a, const O: u8> = crate::BitWriter<'a, GINTMSK_DEVICEMODE_SPEC, O>;
impl R {
