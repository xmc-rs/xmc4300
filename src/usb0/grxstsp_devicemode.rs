...
pub type R = crate::R<GrxstspDevicemodeSpec>;
...
pub struct GrxstspDevicemodeSpec;
impl crate::RegisterSpec for GrxstspDevicemodeSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`grxstsp_devicemode::R`](R) reader structure"]
impl crate::Readable for GrxstspDevicemodeSpec {}
#[doc = "`reset()` method sets GRXSTSP_DEVICEMODE to value 0"]
impl crate::Resettable for GrxstspDevicemodeSpec {
