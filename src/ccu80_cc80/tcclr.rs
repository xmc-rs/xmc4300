...
#[doc = "Write proxy for field `DTC1C`"]
pub struct DTC1C_W<'a> {
    w: &'a mut W,
}
impl<'a> DTC1C_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `DTC2C`"]
pub struct DTC2C_W<'a> {
    w: &'a mut W,
}
impl<'a> DTC2C_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[inline(always)]
    pub fn dtc1c(&mut self) -> DTC1C_W {
        DTC1C_W { w: self }
    }
    #[doc = "Bit 4 - Dead Time Counter 2 Clear"]
    #[inline(always)]
    pub fn dtc2c(&mut self) -> DTC2C_W {
        DTC2C_W { w: self }
    }
}
