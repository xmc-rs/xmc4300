...
pub struct CM1SR_R(crate::FieldReader<u8, CM1SR_A>);
impl CM1SR_R {
    pub(crate) fn new(bits: u8) -> Self {
        CM1SR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CM1SR_R {
    type Target = crate::FieldReader<u8, CM1SR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct CM2SR_R(crate::FieldReader<u8, CM2SR_A>);
impl CM2SR_R {
    pub(crate) fn new(bits: u8) -> Self {
        CM2SR_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for CM2SR_R {
    type Target = crate::FieldReader<u8, CM2SR_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
