...
impl W {
    ...
    #[inline(always)]
    pub fn scm1u(&mut self) -> SCM1U_W<'_, SWS_SPEC> {
        SCM1U_W::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 1 Compare match while counting down set"]
    #[inline(always)]
    pub fn scm1d(&mut self) -> SCM1D_W<'_, SWS_SPEC> {
        SCM1D_W::new(self, 3)
    }
    #[doc = "Bit 4 - Compare match while counting up set"]
    #[inline(always)]
    pub fn scm2u(&mut self) -> SCM2U_W<'_, SWS_SPEC> {
        SCM2U_W::new(self, 4)
    }
    #[doc = "Bit 5 - Compare match while counting down set"]
    #[inline(always)]
    pub fn scm2d(&mut self) -> SCM2D_W<'_, SWS_SPEC> {
        SCM2D_W::new(self, 5)
    }
