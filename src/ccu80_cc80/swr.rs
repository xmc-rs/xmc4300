...
pub type RCM1U_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RCM1D` writer - Channel 1 Compare match while counting down clear"]
pub type RCM1D_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RCM2U` writer - Channel 2 Compare match while counting up clear"]
pub type RCM2U_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `RCM2D` writer - Channel 2 Compare match while counting down clear"]
pub type RCM2D_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
