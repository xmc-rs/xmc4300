...
#[doc = "Capture Register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`c0v::R`](R). WARN: One or more dependent resources other than the current register are immediately affected by a read operation. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct C0vSpec;
impl crate::RegisterSpec for C0vSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`c0v::R`](R) reader structure"]
impl crate::Readable for C0vSpec {}
#[doc = "`reset()` method sets C0V to value 0"]
impl crate::Resettable for C0vSpec {
