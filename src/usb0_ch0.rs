...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn hctsiz_scatgather(&self) -> &HctsizScatgather {
    ...
    #[inline(always)]
    pub const fn hcdma_scatgather(&self) -> &HcdmaScatgather {
        unsafe { &*(self as *const Self).cast::<u8>().add(20).cast() }
    }
    #[doc = "0x14 - Host Channel DMA Address Register \\[BUFFERMODE\\]"]
    #[inline(always)]
    pub const fn hcdma_buffermode(&self) -> &HcdmaBuffermode {
        unsafe { &*(self as *const Self).cast::<u8>().add(20).cast() }
    }
...
module"]
#[doc(alias = "HCTSIZ_BUFFERMODE")]
pub type HctsizBuffermode = crate::Reg<hctsiz_buffermode::HctsizBuffermodeSpec>;
...
module"]
#[doc(alias = "HCTSIZ_SCATGATHER")]
pub type HctsizScatgather = crate::Reg<hctsiz_scatgather::HctsizScatgatherSpec>;
...
module"]
#[doc(alias = "HCDMA_BUFFERMODE")]
pub type HcdmaBuffermode = crate::Reg<hcdma_buffermode::HcdmaBuffermodeSpec>;
...
module"]
#[doc(alias = "HCDMA_SCATGATHER")]
pub type HcdmaScatgather = crate::Reg<hcdma_scatgather::HcdmaScatgatherSpec>;
...
module"]
#[doc(alias = "HCDMAB")]
pub type Hcdmab = crate::Reg<hcdmab::HcdmabSpec>;
