...
#[doc = r" Proxy"]
pub struct _SS_UPD_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _SS_UPD_ENW<'a> {
...
#[doc = r" Proxy"]
pub struct _DS_UPD_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _DS_UPD_ENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn ss_upd_en(&self) -> SS_UPD_ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 6;
    ...
    #[inline]
    pub fn ds_upd_en(&self) -> DS_UPD_ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 5;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 6 - Source Status Update Enable"]
    #[inline]
    pub fn ss_upd_en(&mut self) -> _SS_UPD_ENW {
        _SS_UPD_ENW { w: self }
    }
    #[doc = "Bit 5 - Destination Status Update Enable"]
    #[inline]
    pub fn ds_upd_en(&mut self) -> _DS_UPD_ENW {
        _DS_UPD_ENW { w: self }
    }
    #[doc = "Bits 2:4 - Protection Control"]
    #[inline]
