...
#[doc = "Reader of field `SS_UPD_EN`"]
pub type SS_UPD_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SS_UPD_EN`"]
...
#[doc = "Reader of field `DS_UPD_EN`"]
pub type DS_UPD_EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DS_UPD_EN`"]
