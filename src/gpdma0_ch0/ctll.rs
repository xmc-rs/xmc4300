...
impl W {
    ...
    #[doc = "Bit 17 - Source gather enable"]
    #[inline(always)]
    pub fn src_gather_en(&mut self) -> SRC_GATHER_EN_W<'_, CTLL_SPEC> {
        SRC_GATHER_EN_W::new(self, 17)
    }
    #[doc = "Bit 18 - Destination scatter enable"]
    #[inline(always)]
    pub fn dst_scatter_en(&mut self) -> DST_SCATTER_EN_W<'_, CTLL_SPEC> {
    ...
    #[doc = "Bit 27 - Linked List Pointer for Destination Enable"]
    #[inline(always)]
    pub fn llp_dst_en(&mut self) -> LLP_DST_EN_W<'_, CTLL_SPEC> {
        LLP_DST_EN_W::new(self, 27)
    }
    #[doc = "Bit 28 - Linked List Pointer for Source Enable"]
    #[inline(always)]
    pub fn llp_src_en(&mut self) -> LLP_SRC_EN_W<'_, CTLL_SPEC> {
