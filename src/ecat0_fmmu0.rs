...
#[doc = "FMMU_L_START_ADR (r) register accessor: Logical Start address FMMU\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_l_start_adr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_l_start_adr`] module"]
...
#[doc = "FMMU_LEN (r) register accessor: Length FMMU 0\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_len::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_len`] module"]
pub type FMMU_LEN = crate::Reg<fmmu_len::FMMU_LEN_SPEC>;
#[doc = "Length FMMU 0"]
pub mod fmmu_len;
#[doc = "FMMU_L_START_BIT (r) register accessor: Start bit FMMU 0 in logical address space\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_l_start_bit::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_l_start_bit`] module"]
...
#[doc = "FMMU_L_STOP_BIT (r) register accessor: Stop bit FMMU 0 in logical address space\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_l_stop_bit::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_l_stop_bit`] module"]
...
#[doc = "FMMU_P_START_ADR (r) register accessor: Ph0sical Start address FMMU y\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_p_start_adr::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_p_start_adr`] module"]
...
#[doc = "FMMU_P_START_BIT (r) register accessor: Ph0sical Start bit FMMU y\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_p_start_bit::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_p_start_bit`] module"]
...
#[doc = "FMMU_TYPE (r) register accessor: T0pe FMMU y\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_type::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_type`] module"]
pub type FMMU_TYPE = crate::Reg<fmmu_type::FMMU_TYPE_SPEC>;
#[doc = "T0pe FMMU y"]
pub mod fmmu_type;
#[doc = "FMMU_ACT (r) register accessor: Activate FMMU 0\n\nYou can [`read`](crate::Reg::read) this register and get [`fmmu_act::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fmmu_act`] module"]
